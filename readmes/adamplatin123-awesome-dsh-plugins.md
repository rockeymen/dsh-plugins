...
| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 2055 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [modlens](https://github.com/liustack/modlens) | 1385 | The first vision plugin for DeepSeek Harness, and the v… |
| 3 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1310 | Local-first AI token usage & cost tracker for 31 coding… |
| 4 | [PicGo-Core](https://github.com/PicGo/PicGo-Core) | 970 | :zap:The ultimate image uploading engine. Both CLI & AP… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 949 | 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交… |
| 6 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 828 | 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理 |
| 7 | [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 578 | Open-source CMA-compatible agent runtime for any model,… |
| 8 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 357 | 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还… |
| 9 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 354 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
| 10 | [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) | 326 | Open-source alternative to Claude Cowork — a local-firs… |
| 11 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 260 | AgentTeams plugin for DeepSeek Harness |
| 12 | [Bigfish](https://github.com/turtle2209/Bigfish) | 180 | Bigfish —— DeepSeek Harness 的第三方桌面端，内置 Node 运行时，双击即用，附带… |
| 13 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 173 | 一站式 DeepSeek Harness 社区发行版：TUI、桌面端与 Web UI 三种形态统一体验，支持分… |
| 14 | [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 145 | Codex-style @file mentions for DeepSeek Harness: search… |
| 15 | [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 137 | dsh-tianshu-tui — DeepSeek Harness terminal UI +harness… |
| 16 | [whale-girl](https://github.com/vlln/whale-girl) | 137 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。官方 re… |
| 17 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 99 | dsh plugin: Chrome sidebar extension that lets DSH oper… |
