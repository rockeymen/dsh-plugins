...
function englishHome(zhHtml) {
  const replacements = [
    ...
    ['<nav class="discovery-links" aria-label="DeepSeek Harness 指南与趋势"><a href="/guide/deepseek-harness/">DeepSeek Harness 是什么与安装</a><a href="/trending/">插件涨星榜</a></nav>', '<nav class="discovery-links" aria-label="DeepSeek Harness guides and trends"><a href="/en/guide/deepseek-harness/">What is DeepSeek Harness?</a><a href="/en/trending/">Trending plugins</a></nav>'],
