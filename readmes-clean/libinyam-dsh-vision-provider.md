...
- **Variable**: `DSH_VISION_DISPLAY_NAME` · **Purpose**: Composite provider label · **Default**: `DeepSeek + Vision`
- **Variable**: `DSH_VISION_COMPOSITE_MODEL` · **Purpose**: Backward-compatible preferred combination ID and prefix for additional IDs · **Default**: `deepseek-v4-flash`
- **Variable**: `DSH_VISION_COMPOSITE_NAME` · **Purpose**: Fallback name when the main model name cannot be read · **Default**: `DeepSeek V4 Flash + Vision`
- **Variable**: `DSH_VISION_MAIN_PROVIDER` · **Purpose**: Internal text/reasoning provider · **Default**: `deepseek-official`
- **Variable**: `DSH_VISION_MAIN_MODEL` · **Purpose**: Internal DeepSeek model · **Default**: `deepseek-v4-flash`
- **Variable**: `DSH_VISION_BASE_URL` · **Purpose**: Vision API root · **Default**: `https://api.openai.com/v1`
- **Variable**: `DSH_VISION_MODEL` · **Purpose**: Vision model ID for the direct combination · **Default**: `gpt-4.1-mini`
- **Variable**: `DSH_VISION_MODEL_NAME` · **Purpose**: Vision model display name shown in Web UI · **Default**: `GPT-4.1 mini (Vision)`
- **Variable**: `DSH_VISION_API_KEY_ENV` · **Purpose**: Vision credential reference · **Default**: `VISION_OPENAI_API_KEY`
- **Variable**: `DSH_VISION_NO_AUTH` · **Purpose**: Use placeholder auth when set to `1` · **Default**: unset
- **Variable**: `DSH_VISION_MAX_TOKENS` · **Purpose**: Maximum vision-analysis output · **Default**: `4096`
- **Variable**: `DSH_VISION_TIMEOUT_MS` · **Purpose**: Request timeout for direct and registered vision models · **Default**: `120000`
- **Variable**: `DSH_VISION_DETAIL` · **Purpose**: OpenAI image detail: `auto`, `low`, or `high` · **Default**: `auto`
- **Variable**: `DSH_VISION_USE_LEGACY` · **Purpose**: Make the configured registered route the preferred combination; set `0` to prefer direct · **Default**: enabled
- **Variable**: `DSH_VISION_LEGACY_PROVIDER` · **Purpose**: Preferred registered vision provider route · **Default**: `vision-openai`
- **Variable**: `DSH_VISION_LEGACY_MODEL` · **Purpose**: Optional preferred model ID; otherwise use that route's first image model · **Default**: unset
