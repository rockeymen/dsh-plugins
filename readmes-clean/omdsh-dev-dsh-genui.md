...
https://github.com/user-attachments/assets/f5db33ec-7471-4d4a-a85b-79c9962ab4ef
  ...
  ![Real rendering: an interactive monitoring panel](./assets/showcase-panel.png)
...
- **Function plots**: `plot` draws curves; parameter sliders redraw in real time, with optional auto-animation
  ...
  ![Function plotting: drag a slider for live redraw](./assets/showcase-plot.png)
...
- **Chart error self-healing**: mermaid failures auto-retry with repairs (strip backticks, quote Chinese/space labels, remove ``) before degrading to source; a broken chart never hits the screen
