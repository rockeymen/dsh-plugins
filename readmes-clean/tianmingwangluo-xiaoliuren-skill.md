...
### 优先级 · 目录 · 说明
- **优先级**: 项目级 · **目录**: `<项目根>/.dsh/skills/` · **说明**: 仅该项目会话可用
- **优先级**: 项目级 · **目录**: `<项目根>/.agents/skills/` · **说明**: 兼容共享 agent 配置
- **优先级**: 用户级 · **目录**: `~/.dsh/skills/` · **说明**: 所有会话可用（推荐）
- **优先级**: 用户级 · **目录**: `~/.agents/skills/` · **说明**: 兼容共享 agent 配置
...
- **宫位**: 留连 · **道传（本技能·正确）**: **土** · **网络常见（错误）**: 水
- **宫位**: 小吉 · **道传（本技能·正确）**: **水** · **网络常见（错误）**: 土
