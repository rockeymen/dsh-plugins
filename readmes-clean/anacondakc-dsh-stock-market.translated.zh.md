...
### 数据源 · 接口数 · 主要能力
- **数据源**: 东方财富 · **接口数**: 36 · **主要能力**: 实时/批量行情、排行、K 线、分时、资金流、数据中心、F10、研报、资讯、搜索
- **数据源**: 腾讯财经 · **接口数**: 6 · **主要能力**: 批量实时行情、K 线、分时、个股/板块排行、个股资讯
- **数据源**: 新浪财经 · **接口数**: 13 · **主要能力**: 批量实时行情、K 线、市场/板块、资金流、滚动新闻及页面型数据
- **数据源**: 同花顺 · **接口数**: 2 · **主要能力**: 日 K、分时走势
