...
### 字段 · 默认 · 说明
- **字段**: `model` · **默认**: `pro` · **说明**: 计价模型：`pro` / `flash`
- **字段**: `refreshIntervalSeconds` · **默认**: `30` · **说明**: 余额轮询间隔（秒）
- **字段**: `apiKeyEnv` · **默认**: `DEEPSEEK_API_KEY` · **说明**: API key 的环境变量名
- **字段**: `baseUrl` · **默认**: `https://api.deepseek.com` · **说明**: 余额接口 base URL
- **字段**: `pricingRefreshHours` · **默认**: `6` · **说明**: 官方定价页抓取间隔（小时）
- **字段**: `enabled` · **默认**: `true` · **说明**: 是否启用余额查询
