...
- **Check**: **Source pinning** · **Question answered**: Does this specifier identify *immutable* content, or can it change under the same name?
- **Check**: **Registry integrity** · **Question answered**: Do the bytes we received match the digest the registry publishes?
- **Check**: **Install hooks** · **Question answered**: Will code execute during `dsh plugin add`, before any post-install scan can look?
- **Check**: **Build provenance** · **Question answered**: Does a SLSA attestation tie this artifact to a specific commit and CI workflow?
- **Check**: **Artifact vs source** · **Question answered**: Do the published files actually match that commit — and was anything added at publish time?
