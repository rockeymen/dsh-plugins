...
### 插件 · ⭐ · 兼容 · 描述
- **插件**: [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) · **⭐**: 2168 · **兼容**: 🟢 ok · **描述**: DSH Web UI 插件与皮肤合集：任务板、Git 面板等
- **插件**: [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) · **⭐**: 870 · **兼容**: 🟢 ok · **描述**: 侧边栏完整工作台：文件渲染/终端/Git/子代理
- **插件**: [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) · **⭐**: 707 · **兼容**: ⚪ unknown · **描述**: DSH Web 鲸鱼娘皮肤系列（深海女仆工坊）
- **插件**: [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) · **⭐**: 372 · **兼容**: 🟢 ok · **描述**: 给纯文本模型加视觉：图片问答、长截图 OCR、UI 还原
- **插件**: [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) · **⭐**: 55 · **兼容**: ⚪ unknown · **描述**: 把 Claude Code 的 UltraCode 模式带给 DSH，多 Agent 调度可治理
- **插件**: [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) · **⭐**: 47 · **兼容**: 🟢 ok · **描述**: 对话回退：回滚会话与工作区状态
...
- **插件**: [dsh-share](https://github.com/hellodigua/dsh-share) · **⭐**: 18 · **兼容**: 🟢 ok · **描述**: DSH 对话分享插件
- **插件**: [distill](https://github.com/LoserFox/distill) · **⭐**: 16 · **兼容**: ⚪ unknown · **描述**: 自动对话蒸馏：后台 subagent 反省 + 技能更新
...
- **插件**: [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) · **⭐**: 22 · **兼容**: 🟢 ok · **描述**: 连数据库、写 SQL 的插件
- **插件**: [dsh-doctor](https://github.com/coppynight/dsh-doctor) · **⭐**: 3 · **兼容**: 🟢 ok · **描述**: flutter-doctor 风格诊断与安全自动修复
- **插件**: [dsh-interconnect](https://github.com/Chinesezjc/dsh-interconnect) · **⭐**: 26 · **兼容**: 🟢 ok · **描述**: 跨实例消息/事件交接插件
- **插件**: [dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) · **⭐**: 25 · **兼容**: ⚪ unknown · **描述**: OpenBiliClaw 内容推荐 Agent 接入 DSH
- **插件**: [dsh-plugin-check](https://github.com/omdsh-dev/dsh-plugin-check) · **⭐**: 17 · **兼容**: ⚪ unknown · **描述**: 扫描插件仓库清单协议/patch 格式/构建陷阱
- **插件**: [dsh-security-audit](https://github.com/omdsh-dev/dsh-security-audit) · **⭐**: 11 · **兼容**: ⚪ unknown · **描述**: 本机安全审计：配置/插件来源/会话/网络暴露面
...
- **插件**: [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) · **⭐**: 21 · **兼容**: ⚪ unknown · **描述**: Mnemon 三层记忆体深度集成
...
- **插件**: [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) · **⭐**: 7 · **兼容**: ⚪ unknown · **描述**: OpenMAIC：课堂/幻灯片/交互式组件
- **插件**: [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) · **⭐**: 14 · **兼容**: ⚪ unknown · **描述**: MineRU 文档解析工具
- **插件**: [dsh-prompt-studio](https://github.com/Moeblack/dsh-prompt-studio) · **⭐**: 2 · **兼容**: ⚪ unknown · **描述**: 编辑用户与内置系统提示段（实时预览）
- **插件**: [dsh-scholar](https://github.com/lzszq/dsh-scholar) · **⭐**: 15 · **兼容**: 🟢 ok · **描述**: dsh-scholar（文献相关）
- **插件**: [dsh-ssh](https://github.com/UynajGI/dsh-ssh) · **⭐**: 4 · **兼容**: ⚪ unknown · **描述**: SSH 远程执行：ProxyJump 链、SFTP
- **插件**: [dsh-tool-search](https://github.com/vibeinging/dsh-tool-search) · **⭐**: 2 · **兼容**: 🟢 ok · **描述**: 按 agent 按需工具发现与渐进 schema 披露
...
- **插件**: [zotero-wave-rag](https://github.com/Fisfzy/zotero-wave-rag) · **⭐**: 3 · **兼容**: ⚪ unknown · **描述**: 面向 Zotero 论文库的浪潮式 RAG 检索
- **插件**: [modsearch](https://github.com/liustack/modsearch) · **⭐**: 98 · **兼容**: ⚪ unknown · **描述**: DeepSeek Harness 的联网搜索插件。
- **插件**: [dsh-browser](https://github.com/Lum1104/dsh-browser) · **⭐**: 107 · **兼容**: 🟢 ok · **描述**: Chrome 侧边栏扩展，让 DSH 操控浏览器。
...
- **插件**: [dsh-expression](https://github.com/yyh-001/dsh-expression) · **⭐**: 4 · **兼容**: ⚪ unknown · **描述**: 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道
...
- **插件**: [dsh-plugin-graph](https://github.com/erduotong/dsh-plugin-graph) · **⭐**: 2 · **兼容**: 🟢 ok · **描述**: 一个Deepseek Harness的插件关系图谱可视化插件
...
- **插件**: [dsh-vsc-integration](https://github.com/HarcoChen/dsh-vsc-integration) · **⭐**: 5 · **兼容**: ⚪ unknown · **描述**: dsh-vsc-integration — DSH 插件（工具）
...
- **插件**: [deepseek-pet](https://github.com/keleus/deepseek-pet) · **⭐**: 11 · **兼容**: ⚪ unknown · **描述**: 在你的deepseek-harness上养一只吃白饭的大蓝鲸
...
- **插件**: [dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) · **⭐**: 3 · **兼容**: 🟢 ok · **描述**: dsh-composer-history — DSH 插件（工具）
...
- **插件**: [dsh-browser](https://github.com/ben7am1n/dsh-browser) · **⭐**: 1 · **兼容**: 🟢 ok · **描述**: dsh-browser — DSH 插件（工具）
...
- **插件**: [task-passport](https://github.com/dongsheng123132/task-passport) · **⭐**: 5 · **兼容**: 🟢 ok · **描述**: task-passport — DSH 插件（工具）
- **插件**: [dsh-prompt-presets](https://github.com/fff122/dsh-prompt-presets) · **⭐**: 1 · **兼容**: ⚪ unknown · **描述**: dsh-prompt-presets — DSH 插件（工具）
- **插件**: [dsh-hub](https://github.com/coderPerseus/dsh-hub) · **⭐**: 3 · **兼容**: ⚪ unknown · **描述**: dsh-hub — DSH 插件（工具）
...
- **插件**: [dsh-mobile-control](https://github.com/PangYiMing/dsh-mobile-control) · **⭐**: 2 · **兼容**: 🟢 ok · **描述**: dsh-mobile-control — DSH 插件（工具）
- **插件**: [dsh-hub](https://github.com/coderPerseus/dsh-hub) · **⭐**: 3 · **兼容**: ⚪ unknown · **描述**: dsh-hub — DSH 插件（工具）
...
- **插件**: [safe-find-dsh-plugins](https://github.com/Jinsong-Zhou/safe-find-dsh-plugins) · **⭐**: 2 · **兼容**: ⚪ unknown · **描述