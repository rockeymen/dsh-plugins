...
### 插件 · ⭐ · 兼容 · 描述
- **插件**: [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) · **⭐**: 1977 · **兼容**: ⚪ unknown · **描述**: DSH Web UI 插件与皮肤合集：任务板、Git 面板等
- **插件**: [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) · **⭐**: 795 · **兼容**: ⚪ unknown · **描述**: 侧边栏完整工作台：文件渲染/终端/Git/子代理
- **插件**: [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) · **⭐**: 608 · **兼容**: ⚪ unknown · **描述**: DSH Web 鲸鱼娘皮肤系列（深海女仆工坊）
- **插件**: [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) · **⭐**: 339 · **兼容**: ⚪ unknown · **描述**: 给纯文本模型加视觉：图片问答、长截图 OCR、UI 还原
...
- **插件**: [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) · **⭐**: 42 · **兼容**: ⚪ unknown · **描述**: 对话回退：回滚会话与工作区状态
- **插件**: [ui-status-label](https://github.com/alingalingling/ui-status-label) · **⭐**: 30 · **兼容**: ⚪ unknown · **描述**: 自定义「鲸鱼娘」思考状态的显示
- **插件**: [dsh-custom-tool](https://github.com/omdsh-dev/dsh-custom-tool) · **⭐**: 22 · **兼容**: ⚪ unknown · **描述**: Monaco 编辑器创建沙箱 JS 工具
...
- **插件**: [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) · **⭐**: 19 · **兼容**: ⚪ unknown · **描述**: 连数据库、写 SQL 的插件
...
- **插件**: [dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) · **⭐**: 22 · **兼容**: ⚪ unknown · **描述**: OpenBiliClaw 内容推荐 Agent 接入 DSH
...
- **插件**: [dsh-toolkit](https://github.com/omdsh-dev/dsh-toolkit) · **⭐**: 15 · **兼容**: ⚪ unknown · **描述**: 零依赖工具包合集（time/encoding/json/csv/regex）
...
- **插件**: [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) · **⭐**: 16 · **兼容**: ⚪ unknown · **描述**: Mnemon 三层记忆体深度集成
...
- **插件**: [dsh-inspect](https://github.com/omdsh-dev/dsh-inspect) · **⭐**: 4 · **兼容**: ⚪ unknown · **描述**: 检查→修复→复查的对抗式闭环插件
- **插件**: [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) · **⭐**: 6 · **兼容**: ⚪ unknown · **描述**: OpenMAIC：课堂/幻灯片/交互式组件
- **插件**: [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) · **⭐**: 11 · **兼容**: ⚪ unknown · **描述**: MineRU 文档解析工具
- **插件**: [dsh-prompt-studio](https://github.com/Moeblack/dsh-prompt-studio) · **⭐**: 2 · **兼容**: ⚪ unknown · **描述**: 编辑用户与内置系统提示段（实时预览）
- **插件**: [dsh-scholar](https://github.com/lzszq/dsh-scholar) · **⭐**: 14 · **兼容**: ⚪ unknown · **描述**: dsh-scholar（文献相关）
...
- **插件**: [dsh-browser](https://github.com/Lum1104/dsh-browser) · **⭐**: 96 · **兼容**: ⚪ unknown · **描述**: Chrome 侧边栏扩展，让 DSH 操控浏览器。
...
- **插件**: [dsh-github-connector](https://github.com/kaziii/dsh-github-connector) · **⭐**: 3 · **兼容**: ⚪ unknown · **描述**: dsh-github-connector — DSH 插件（工具）
