...
### Method · Path · 说明
- **Method**: GET · **Path**: `/plugins/dsh-session-admin/list` · **说明**: 列出磁盘上的全部会话（现存 + 归档）
- **Method**: POST · **Path**: `/plugins/dsh-session-admin/archive` · **说明**: 归档一个会话
- **Method**: POST · **Path**: `/plugins/dsh-session-admin/unarchive` · **说明**: 取消归档一个会话
- **Method**: POST · **Path**: `/plugins/dsh-session-admin/delete` · **说明**: 永久删除一个会话
- **Method**: POST · **Path**: `/plugins/dsh-session-admin/batch` · **说明**: 批量归档 / 取消归档 / 删除
