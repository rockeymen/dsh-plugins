...
- **Benchmark**: HLE（无工具） · **V4-Flash-0731**: 37.8 · **V4-Flash-0731 + J-Space**: 45.5 · **V4-Pro-0813**: 42.7 · **V4-Pro-0813 + J-Space**: 48.0 · **GLM-5.3**: — · **Kimi-K3**: 43.5 · **Opus-4.8**: 49.8 · **Fable 5（w/ fallback）**: **53.3**
- **Benchmark**: HLE（有工具） · **V4-Flash-0731**: 51.5 · **V4-Flash-0731 + J-Space**: 60.6 · **V4-Pro-0813**: 60.0 · **V4-Pro-0813 + J-Space**: **67.7** · **GLM-5.3**: 62.5 · **Kimi-K3**: 56.0 · **Opus-4.8**: 57.9 · **Fable 5（w/ fallback）**: 63.0
- **Benchmark**: Terminal Bench 2.1 · **V4-Flash-0731**: 82.7 · **V4-Flash-0731 + J-Space**: 87.1 · **V4-Pro-0813**: 87.9 · **V4-Pro-0813 + J-Space**: **90.1** · **GLM-5.3**: 88.2 · **Kimi-K3**: 88.3 · **Opus-4.8**: 85.0 · **Fable 5（w/ fallback）**: 88.0
- **Benchmark**: NL2Repo · **V4-Flash-0731**: 54.2 · **V4-Flash-0731 + J-Space**: 70.2 · **V4-Pro-0813**: 61.5 · **V4-Pro-0813 + J-Space**: **73.4** · **GLM-5.3**: 58.0 · **Kimi-K3**: 58.0 · **Opus-4.8**: 69.7 · **Fable 5（w/ fallback）**: —
- **Benchmark**: CyberGym · **V4-Flash-0731**: 76.7 · **V4-Flash-0731 + J-Space**: 81.7 · **V4-Pro-0813**: 83.3 · **V4-Pro-0813 + J-Space**: **86.8** · **GLM-5.3**: 84.5 · **Kimi-K3**: 80.0 · **Opus-4.8**: 78.3 · **Fable 5（w/ fallback）**: 83.1
- **Benchmark**: DeepSWE · **V4-Flash-0731**: 54.4 · **V4-Flash-0731 + J-Space**: 67.4 · **V4-Pro-0813**: 62.7 · **V4-Pro-0813 + J-Space**: **72.0** · **GLM-5.3**: 66.9 · **Kimi-K3**: 67.5 · **Opus-4.8**: 58.0 · **Fable 5（w/ fallback）**: 70.0
- **Benchmark**: Toolathlon-Verified · **V4-Flash-0731**: 70.3 · **V4-Flash-0731 + J-Space**: 77.7 · **V4-Pro-0813**: 74.1 · **V4-Pro-0813 + J-Space**: **79.5** · **GLM-5.3**: 73.0 · **Kimi-K3**: 76.5 · **Opus-4.8**: 76.2 · **Fable 5（w/ fallback）**: 77.9
- **Benchmark**: Agents' Last Exam · **V4-Flash-0731**: 25.2 · **V4-Flash-0731 + J-Space**: 30.1 · **V4-Pro-0813**: 25.7 · **V4-Pro-0813 + J-Space**: **30.3** · **GLM-5.3**: 28.5 · **Kimi-K3**: 27.6 · **Opus-4.8**: 25.7 · **Fable 5（w/ fallback）**: 23.8
- **Benchmark**: AutomationBench（Public） · **V4-Flash-0731**: 25.1 · **V4-Flash-0731 + J-Space**: 31.7 · **V4-Pro-0813**: 31.8 · **V4-Pro-0813 + J-Space**: 38.2 · **GLM-5.3**: **48.2** · **Kimi-K3**: 30.8 · **Opus-4.8**: 27.2 · **Fable 5（w/ fallback）**: 29.1
...
- **Benchmark 类型**: Agents' Last Exam · **主要限制**: 异构任务与模式选择 · **J-Space 的主要作用**: 自适应 pass、选择性模块、恢复 · **结果形态**: 不假定单一 persona 普遍最优
- **Benchmark 类型**: AutomationBench · **主要限制**: 持久工作流和依赖推进 · **J-Space 的主要作用**: Goal、稳定 Open、明确 Next、长间隔恢复 · **结果形态**: Loop 与任务结构高度匹配
...
- **指标**: 得分 / 时间 · **Control**: 0.43 · **J-Space**: **1.09** · **相对增益**: **2.53×**
- **指标**: 得分 / Token · **Control**: 0.38 · **J-Space**: **0.84** · **相对增益**: **2.21×**
...
- **控制层**: 首轮接口恢复 · **Anchored Standard**: 强 · **Routing Suite**: 强 · **J-Space**: 非 DeepSeek 专属
- **控制层**: 任务行为带选择 · **Anchored Standard**: 固定偏向 Minimal · **Routing Suite**: 强 · **J-Space**: 通过 pass 与功能角色间接选择
- **控制层**: 轨迹持续维持 · **Anchored Standard**: 有限 · **Routing Suite**: 近场引导 · **J-Space**: 功能性回响 + seam 审计
- **控制层**: 推理深度调节 · **Anchored Standard**: 非重点 · **Routing Suite**: 深度自适应 · **J-Space**: fast/full/loop + 分段控制
- **控制层**: 活动容量与广播 · **Anchored Standard**: 无完整协议 · **Routing Suite**: 非重点 · **J-Space**: 明确协议
- **控制层**: 持久状态 · **Anchored Standard**: 阶段状态 · **Routing Suite**: 会话路由状态 · **J-Space**: Goal/Core/Verified/Open/Next
- **控制层**: 验证覆盖 · **Anchored Standard**: 非重点 · **Routing Suite**: 决策闭合 · **J-Space**: verifier + coverage + done-check
- **控制层**: 失败恢复 · **Anchored Standard**: 非重点 · **Routing Suite**: anti-runaway · **J-Space**: 标记、诊断重试、Empirics、resume
- **控制层**: 跨平台与跨模型 · **Anchored Standard**: 较弱 · **Routing Suite**: 较弱 · **J-Space**: 强
