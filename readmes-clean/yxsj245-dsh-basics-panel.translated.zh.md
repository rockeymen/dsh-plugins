...
- **能力**: 技能 · **全局**: — · **项目级**: `<项目>/.dsh/skills`、`<项目>/.agents/skills` · **用户级**: `~/.dsh/skills`、`~/.agents/skills` · **预设级**: — · **内置**: 随发行版内置
- **能力**: MCP · **全局**: — · **项目级**: DSH 暂无项目级组合文件 · **用户级**: `~/.dsh/cordis.patch.yml`、`~/.dsh/profiles/*/cordis.patch.yml` · **预设级**: `~/.dsh/.agent-presets/*/agent.cordis.yml` · **内置**: —
- **能力**: 规则 · **全局**: `~/.dsh/AGENTS.md` · **项目级**: 项目根至 cwd 链上的 `AGENTS.md` / `CLAUDE.md` / `.local` · **用户级**: — · **预设级**: — · **内置**: —
