...
DSH（DeepSeek Harness）的 Live2D 桌宠插件：**支持任意外部 URL 或本地模型地址加载 Live2D 模型**。
  ...
  ![dsh-live2d-pets 主视觉](docs/media/hero.jpg)
...
打开 **DSH 设置 →「桌宠配置」**，改完立刻生效，无需重启。
  ...
  ![DSH 设置中的「桌宠配置」入口与面板](docs/media/settings-pet-config.png)
...
### 需求 · 文档
- **需求**: 产品意图 · **文档**: `[docs/intent/live2d-pet-plugin.md](docs/intent/live2d-pet-plugin.md)`
- **需求**: 行为规格 · **文档**: `[docs/spec/live2d-pet-v01.md](docs/spec/live2d-pet-v01.md)`
- **需求**: 架构决策 · **文档**: `[docs/adr/](docs/adr/)`（渲染栈见 ADR-003）
- **需求**: 调研记录 · **文档**: `[docs/research/](docs/research/)`（设置面板接入机制见 settings-tab.md）
