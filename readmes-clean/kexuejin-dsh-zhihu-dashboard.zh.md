...
### 工具 · 作用
- **工具**: `zhihu_search` · **作用**: 搜索知乎内容（标题/作者/摘要/链接）
- **工具**: `zhihu_hot` · **作用**: 当前热榜
- **工具**: `zhihu_answer` · **作用**: 知乎直答（检索增强回答 / 应用创意提炼）
- **工具**: `zhihu_global_search` · **作用**: 全网搜索，支持时间窗（`sinceHours`）与实时索引
- **工具**: `zhihu_followees` · **作用**: 列出当前账号关注的人
- **工具**: `zhihu_my_contents` · **作用**: 我的创作（可按点赞排序分析最佳内容）
- **工具**: `zhihu_favorites` · **作用**: 收藏夹列表 / 单个收藏夹内容
...
### 选项 · 默认 · 说明
- **选项**: `cliPath` · **默认**: 自动探测 · **说明**: zhihu-cli 二进制路径
- **选项**: `hotLimit` · **默认**: 10 · **说明**: 热榜条数 (1-30)
- **选项**: `feedLimit` · **默认**: 10 · **说明**: 动态条数 (1-50)
- **选项**: `refreshSeconds` · **默认**: 0 · **说明**: 热榜/动态自动刷新秒数（0=关）
