![Axern — infrastructure for AI agents: untrusted code runs behind a runsc isolation boundary, trusted services run on runc, under one resource and lifecycle model](./assets/readme/hero.gif)
...
> It is suitable for evaluation and contribution, but operators should review the security and production boundaries before deploying multi-tenant workloads.
  ...
  ![Terminal recording of the axern CLI: command surface and run creation flags](./apps/docs/public/terminal/axern.gif)
