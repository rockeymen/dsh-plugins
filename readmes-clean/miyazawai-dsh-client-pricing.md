...
- **生效区间**: 现在 → 2026-08-17 00:00 北京 · **模型**: flash · **缓存命中**: 0.02 · **缓存未命中**: 1 · **输出**: 2
- **生效区间**: 同上 · **模型**: pro · **缓存命中**: 0.025 · **缓存未命中**: 3 · **输出**: 6
- **生效区间**: 2026-08-17 起 · 空闲 · **模型**: flash · **缓存命中**: 0.05 · **缓存未命中**: 1.5 · **输出**: 4.5
- **生效区间**: 2026-08-17 起 · 高峰 · **模型**: flash · **缓存命中**: 0.10 · **缓存未命中**: 3.0 · **输出**: 9.0
- **生效区间**: 2026-08-17 起 · 空闲 · **模型**: pro · **缓存命中**: 0.15 · **缓存未命中**: 4.5 · **输出**: 13.5
- **生效区间**: 2026-08-17 起 · 高峰 · **模型**: pro · **缓存命中**: 0.30 · **缓存未命中**: 9.0 · **输出**: 27.0
...
### 要改什么 · 常量/函数
- **要改什么**: 现行一口价（峰谷生效前） · **常量/函数**: `LEGACY_PRICES`（flash/pro 的 hit/miss/output）
- **要改什么**: 峰谷高峰价（生效后） · **常量/函数**: `PEAK_PRICES`（空闲价 = 高峰 × 0.5，自动派生）
- **要改什么**: 峰谷生效时刻 · **常量/函数**: `NEW_PRICING_UTC_MS`（UTC 毫秒时间戳）
- **要改什么**: 高峰时段窗口 · **常量/函数**: `PEAK_WINDOWS`（北京时间小时，左闭右开）
