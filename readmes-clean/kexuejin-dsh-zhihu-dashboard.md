...
### Tool · What it does
- **Tool**: `zhihu_search` · **What it does**: Search Zhihu content (titles/authors/summaries/links)
- **Tool**: `zhihu_hot` · **What it does**: Current hot list
- **Tool**: `zhihu_answer` · **What it does**: Zhihu Zhida (retrieval-augmented answer / app-idea distillation)
- **Tool**: `zhihu_global_search` · **What it does**: Whole-web search with a recency window (`sinceHours`) and realtime index
- **Tool**: `zhihu_followees` · **What it does**: List the users your account follows
- **Tool**: `zhihu_my_contents` · **What it does**: Your own creations (sortable by likes to find your best content)
- **Tool**: `zhihu_favorites` · **What it does**: Favorite collections / one collection's items
...
- **Option**: `cliPath` · **Default**: auto-detect · **Meaning**: Path to the zhihu-cli binary
- **Option**: `hotLimit` · **Default**: 10 · **Meaning**: Hot list item count (1-30)
- **Option**: `feedLimit` · **Default**: 10 · **Meaning**: Feed item count (1-50)
- **Option**: `refreshSeconds` · **Default**: 0 · **Meaning**: Auto-refresh for hot/feed (0 = off)
