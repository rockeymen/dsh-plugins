...
## 💜 赞助商
      ...
      感谢 优云智算 赞助了本项目!优云智算是 UCloud 旗下 AI 云平台,提供稳定、全面的国内外模型 API,仅一个 key 即可调用。主打包月、按次的高性价比国模 Coding Plan 套餐,支持 GLM5.2;同时提供官转稳定海外模型。支持接入 Claude Code、Codex 及 API 调用,支持企业高并发、7×24 技术支持、自助开票。通过[此链接](https://passport.compshare.cn/register?referral_code=LlOJAWughXiDXtP9v1Srra)注册的用户,可得免费 5 元平台体验金!
...
很多朋友让我帮他们安装 **Claude Code**、**OpenClaw**、**Hermes Agent**……不但每个人的系统都不一样,甚至有些人还抠门到不愿花钱买大模型,安装和解释起来都特别费劲。于是我开发了这个叫「EchoBird」的 Agent —— 灵感来自《赛博朋克 2077》里那位聪慧过人、总能帮主角搞定一切技术难题的天才女助理 **Songbird**…
  ...
  ![EchoBird —— 我的 AI 生涯仪表盘](https://github.com/user-attachments/assets/162f0428-a44d-4e83-9e10-c6b580ef0120)
...
> 白天和晚上,左右对照看一眼 —— 下面其他截图会跟着你 GitHub 的主题切换。
  ...
  ![AI 资讯(浅色)](docs/screenshots/news-cn-light.png)
  ![AI 资讯(深色)](docs/screenshots/news-cn-dark.png)
...
### 模型中心 —— 模型数据中枢,一处配置,四处生效
  ...
  ![](docs/screenshots/model-cn-light.png)

### 应用管理 —— 所有 AI / Agent 应用一键启动与管理

  
  ![](docs/screenshots/app-cn-light.png)

### 本地大模型 —— 在自己机器上跑

  
  ![](docs/screenshots/localllm-cn-light.png)

### 安装与修复 —— 用对话搞定部署和排障

  
  ![](docs/screenshots/agent-cn-light.png)
...
### 平台 · 安装包
- **平台**: Windows x64 · **安装包**: `EchoBird_<ver>_Windows_x64-setup.exe`
- **平台**: macOS(Apple Silicon) · **安装包**: `EchoBird_<ver>_macOS_arm64.dmg`
- **平台**: Linux x64 · Debian/Ubuntu · **安装包**: `EchoBird_<ver>_Linux_x64.deb`
- **平台**: Linux arm64 · Debian/Ubuntu · **安装包**: `EchoBird_<ver>_Linux_arm64.deb`
- **平台**: Linux x64 · Fedora/RHEL · **安装包**: `EchoBird_<ver>_Linux_x64.rpm`
- **平台**: Linux arm64 · Fedora/RHEL · **安装包**: `EchoBird_<ver>_Linux_arm64.rpm`
...
三个或以上**(详见 [NOTICE](NOTICE) 阈值)。完整政策见 [TRADEMARKS.md](TRADEMARKS.md)。
  ...
  <sub>⭐ [在 GitHub 上点个 Star](https://github.com/edison7009/EchoBird) · [English README](README.md)</sub>