...
### 命令 · 说明
- **命令**: `/praise` · **说明**: 随机夸你一句
- **命令**: `/fortune` · **说明**: 抽一张开发者今日运势
- **命令**: `/report` · **说明**: 生成今天的摸鱼战报
- **命令**: `/season` · **说明**: 查看当前赛季的插件互动战绩
- **命令**: `/pomodoro 25` · **说明**: 开始一个 25 分钟番茄钟
- **命令**: `/pomodoro-status` · **说明**: 查看剩余时间
- **命令**: `/pomodoro-stop` · **说明**: 停止番茄钟
- **命令**: `/break` · **说明**: 随机一条休息建议
- **命令**: `/break-go` · **说明**: 打开自定义摸鱼目标：网址或本地程序路径
- **命令**: `/pet` · **说明**: 摸摸桌宠的头
- **命令**: `/feed` · **说明**: 给桌宠喂食
- **命令**: `/persona` · **说明**: 查看或切换 AI 说话人设
