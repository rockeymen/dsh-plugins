...
### 状态 · 鲸鱼表现 · 含义
- **状态**: 🔴 需要确认 · **鲸鱼表现**: 瞪眼 + 眉毛 + o 嘴 + 提示音 · **含义**: 有审批/提问等你处理
- **状态**: 🔵 工作中 · **鲸鱼表现**: 专注眼 + 喷水动画 · **含义**: 有会话正在运行
- **状态**: 🟢 完成待查看 · **鲸鱼表现**: 开心眯眼 ^^ + 星星 · **含义**: 任务刚完成，去看结果
- **状态**: 💤 空闲 · **鲸鱼表现**: 睡觉 + zzz · **含义**: 无任务，安心休息
- **状态**: 😵 离线 · **鲸鱼表现**: 灰度 + X 眼 · **含义**: 连不上 DSH，自动重试
...
### 平台 · 安装包 · 说明
- **平台**: macOS Apple Silicon · **安装包**: `dsh-pet-<版本>-arm64.dmg` · **说明**: 双击打开，把鲸鱼拖入 Applications
- **平台**: macOS Apple Silicon · **安装包**: `dsh-pet-<版本>-arm64-mac.zip` · **说明**: 便携版，解压即用；删文件夹即卸载
...
### 操作 · 行为
- **操作**: 单击鲸鱼/气泡 · **行为**: 打开 DSH GUI（系统浏览器，可切换桌宠窗口直达会话）
- **操作**: 按住拖拽 · **行为**: 移动位置
- **操作**: 右键鲸鱼/气泡（或托盘图标） · **行为**: 菜单：气泡开关、音效开关、大小调节、打开方式
- **操作**: 滚轮（气泡内） · **行为**: 滚动查看多会话列表
