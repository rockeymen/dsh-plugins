...
3. If design in superdesign
  ...
  3.2 Identify page most relevant, and build a pixel-perfect replica in replica_html_template:
    - `.superdesign/replica_html_template/-<feature>.html`
...
# Optional --template  seeds the first (baseline) draft from an HTML file.
...
superdesign get-design --draft-id  --json          # full HTML payload; or --output  to write to a file
