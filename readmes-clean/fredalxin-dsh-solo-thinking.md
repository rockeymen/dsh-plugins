...
- **安装组合**: 官方 DSH `0.1.0-rc.6` + Solo Thinking · **顶部完整 Tab**: ✓ · **对话右侧栏**: — · **支持情况**: Thinking 工具、自动建议、分支 Session、Handoff、Workspace 继承和完整上下文
- **安装组合**: 再安装 Better Sidebar `>=0.12.1` · **顶部完整 Tab**: ✓ · **对话右侧栏**: ✓ · **支持情况**: 在对话右侧查看思考树、选择节点、控制分支并直接发消息
...
### 工具 · 用途
- **工具**: `thinking_start` · **用途**: 在当前 Session 建立头脑风暴空间
- **工具**: `thinking_suggest` · **用途**: 一次创建 2–4 个休眠建议方向
- **工具**: `thinking_split` · **用途**: Agent 自主分裂并写入定向 Handoff
- **工具**: `thinking_fork_handoff` · **用途**: 为人工创建的待继承节点补齐父分支 Handoff
- **工具**: `thinking_checkpoint` · **用途**: 发布本分支 Current State
- **工具**: `thinking_return` · **用途**: 向父分支提交最终 Handoff 并封存
- **工具**: `thinking_status` · **用途**: 读取当前节点和整棵树状态
