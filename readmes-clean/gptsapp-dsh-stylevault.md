...
- **Nord（深色）**: ![Nord dark](docs/screenshots/preview-dark-nord.png) · **Nord Light（浅色）**: ![Nord light](docs/screenshots/preview-light-nord.png)
...
### 文件 · 角色
- **文件**: `lib/client.js` · **角色**: 客户端主实现（ModuleLoader），含全部预设与设置面板
- **文件**: `lib/index.js` · **角色**: Host 空壳（呈现全部在客户端）
