...
### 思考 · 工作
- **思考**: ![大肥鱼思考状态](docs/images/status-thinking.png) · **工作**: ![大肥鱼工作状态](docs/images/status-working.png)

### 等待确认 · 完成
- **等待确认**: ![大肥鱼等待用户确认](docs/images/status-waiting.png) · **完成**: ![大肥鱼任务完成](docs/images/status-success.png)

### 遇到问题
- **遇到问题**: ![大肥鱼错误状态](docs/images/status-error.png)
...
### 设置 · 作用
- **设置**: 启用大肥鱼 · **作用**: 立即显示或关闭桌面伴侣
- **设置**: 角色大小 · **作用**: 在 70%～140% 之间调整
- **设置**: 活跃程度 · **作用**: 控制空闲时眨眼、观察等微动作频率
- **设置**: 减少动态效果 · **作用**: 减少走动、循环帧和程序化晃动
- **设置**: 响应子 Agent · **作用**: 允许子 Agent 状态参与优先级选择；默认关闭
