...
- 眼识 · **classical**: cakṣur-vijñāna · **in this harness**: what the agent looks at — file contents, search results, rendered output
- 耳识 · **classical**: śrotra-vijñāna · **in this harness**: what the agent is told — user messages, review comments
- 鼻识 · **classical**: ghrāṇa-vijñāna · **in this harness**: what it senses unprompted — code smell, stale config, drifting state
- 舌识 · **classical**: jihvā-vijñāna · **in this harness**: what it tastes of its own product — tests, builds, its own diff re-read
- 身识 · **classical**: kāya-vijñāna · **in this harness**: the world's direct resistance — non-zero exits, failed writes, timeouts
- 意识 · **classical**: mano-vijñāna · **in this harness**: the discriminating turn itself — planning, judging, deciding
- 末那识 · **classical**: kliṣṭa-manas · **in this harness**: the self-grasping undercurrent, measured as four biases
- 阿赖耶识 · **classical**: ālaya-vijñāna · **in this harness**: the durable store of seeds, perfumed and manifesting
...
###  · proxy · counter-move
- 我痴 self-delusion · **proxy**: claims asserted without a verifying observation · **counter-move**: run the check that would falsify it, then restate
- 我见 self-view · **proxy**: retries of an approach evidence already contradicted · **counter-move**: name the position, name what contradicted it, change shape
- 我慢 self-conceit · **proxy**: an unbroken success streak; correction met with justification · **counter-move**: seek the disconfirming case; grant the correction first
- 我爱 self-love · **proxy**: own earlier output reused as independent evidence · **counter-move**: cite the primary source, not your summary of it
...
### tool · what it is for
- **tool**: `self_reflect` · **what it is for**: read the current state and the seeds for a named situation
- **tool**: `self_appraise` · **what it is for**: record how something landed — the half the harness cannot observe
- **tool**: `self_recall` · **what it is for**: search the store for precedents before repeating an approach
- **tool**: `self_transform` · **what it is for**: turn an affliction into its wisdom and commit to the counter-move
