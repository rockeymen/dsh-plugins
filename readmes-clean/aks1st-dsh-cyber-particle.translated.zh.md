...
### 参数 · 默认值 · 范围 · 含义
- **参数**: 粒子数量 · **默认值**: 52 · **范围**: 10–120 · **含义**: 基准数量，绘制时按 `scale²` 缩放（8–240 截断）
- **参数**: 粒子半径 · **默认值**: 2.2 · **范围**: 0.5–6 · **含义**: 半径（px），按 `scale` 缩放
- **参数**: 线条粗细 · **默认值**: 1.2 · **范围**: 0.2–4 · **含义**: 连线宽度（px），按 `scale` 缩放
- **参数**: 连线距离 · **默认值**: 180 · **范围**: 40–400 · **含义**: 连线阈值（px），按 `scale` 缩放
- **参数**: 移动速度 · **默认值**: 3.0 · **范围**: 0.5–8 · **含义**: 基准速度，实际在 `2/3×` 到 `1.4×` 间随机
- **参数**: 粒子颜色 · **默认值**: `#7d8999` · **范围**: 调色板 · **含义**: 散点颜色（固定 0.9 透明度）
- **参数**: 线条颜色 · **默认值**: `#6e7a8c` · **范围**: 调色板 · **含义**: 连线颜色（透明度随距离衰减）
