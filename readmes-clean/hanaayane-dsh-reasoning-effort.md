![dsh-reasoning-effort 为 DeepSeek Harness 提供 Codex 风格的模型与推理强度滑块](assets/readme/hero.webp)
...
![推理强度选择器在 DeepSeek Harness 深色和浅色主题中的真实效果](assets/readme/themes.webp)

## 三个档位分别是什么

### 档位 · 适合场景 · 体验倾向
- **档位**: `off` · **适合场景**: 简单问答、改写、快速操作 · **体验倾向**: 更快
- **档位**: `high` · **适合场景**: 日常编程、分析和多步骤任务 · **体验倾向**: 速度与推理平衡
- **档位**: `max` · **适合场景**: 复杂调试、规划和高难度任务 · **体验倾向**: 更充分的推理
...
![DeepSeek Harness 通用设置中的推理强度滑块和大肥鱼滑块开关](assets/readme/settings.webp)
...
### 组件 · 目标版本
- **组件**: DeepSeek Harness packages · **目标版本**: `0.1.0-rc.6`
- **组件**: Node.js · **目标版本**: `22.19+`
- **组件**: React · **目标版本**: `18.x`
