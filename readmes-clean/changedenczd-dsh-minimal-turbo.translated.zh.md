...
- id: 工具-pwsh
  名称：'@deepseek-ai/dsh-tool-pwsh'
  禁用：!!js process.platform !== 'win32'

- id：工具目标
  名称：'@deepseek-ai/dsh-工具目标'

- id：工具待办事项
  名称：'@deepseek-ai/dsh-tool-todo'
  配置：
    允许并行进行：true

# `web`服务及其搜索提供者留在主机组合中；仅
# 面向模型的工具是针对每个会话的。
- id: 工具网
  名称：'@deepseek-ai/dsh-tool-web'
  配置：
    获取：假
    搜索超时时间：60000
````
...
![](https://github.com/user-attachments/assets/7a24d9d7-874f-4816-b58a-2dbde5adfd59)

![](https://github.com/user-attachments/assets/31a4080d-781f-47de-8226-77a7db7ed3c6)

![](https://github.com/user-attachments/assets/0efdbe16-68eb-492d-b0cb-6345e51c8784)