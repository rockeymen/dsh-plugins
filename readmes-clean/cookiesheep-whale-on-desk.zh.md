...
### Agent 在干嘛 · 鲸鱼在干嘛
- **Agent 在干嘛**: 任务运行中 · **鲸鱼在干嘛**: 快速游泳 🏊
- **Agent 在干嘛**: 模型输出中 · **鲸鱼在干嘛**: 陪它思考,头顶思考泡泡 💭
- **Agent 在干嘛**: 调用工具 · **鲸鱼在干嘛**: 吐一个带友好标签的泡泡(敲命令 / 读文件 / …)
- **Agent 在干嘛**: **请求批准** · **鲸鱼在干嘛**: **贴住屏幕边缘敲玻璃 + 琥珀色脉冲,浏览器标签标题闪 🔔**
- **Agent 在干嘛**: 任务完成 · **鲸鱼在干嘛**: 空翻庆祝 + 开口汇报:"搞定! 3 分 12 秒,跑了 8 个工具,改了 5 个文件" 🎉
- **Agent 在干嘛**: 任务失败 · **鲸鱼在干嘛**: 下沉,眼睛变横线 😢
- **Agent 在干嘛**: 上下文约 62% / 82% · **鲸鱼在干嘛**: 喂鱼时间——"还能吃一点 / 吃饱了" 🍤
- **Agent 在干嘛**: 闲置 5 分钟 · **鲸鱼在干嘛**: 主动讨活:"我闲着呢,有活吗?"
- **Agent 在干嘛**: 闲置 10 分钟 · **鲸鱼在干嘛**: 睡着 💤
- **Agent 在干嘛**: 本地 00:00–06:00 · **鲸鱼在干嘛**: 戴睡帽 🌙
- **Agent 在干嘛**: 悬停鲸鱼 · **鲸鱼在干嘛**: 显示当前任务统计牌(耗时 / 工具数)
- **Agent 在干嘛**: 点击鲸鱼 · **鲸鱼在干嘛**: 惊吓反应 + 随机台词("别戳啦")
- **Agent 在干嘛**: 单击 / 双击它 · **鲸鱼在干嘛**: 吱吱叫 / 惊醒炸毛(带音效)
