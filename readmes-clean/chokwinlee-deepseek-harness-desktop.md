![DeepSeek Harness Desktop icon](build/icon.png)
  # DeepSeek Harness Desktop
  macOS downloads under 90 MB, with the complete Harness runtime included.
  A compact, unofficial desktop host for DeepSeek Harness on macOS and Windows.
  
    · [Installation](#installation)
    · [Why it is compact](#compact-by-design-on-macos)
...
- **macOS installer**: Apple Silicon DMG · **v0.1.1 Electron**: 147.8 MB · **v0.1.2 Tauri**: **86.3 MB** · **Reduction**: **41.6%**
- **macOS installer**: Intel DMG · **v0.1.1 Electron**: 152.6 MB · **v0.1.2 Tauri**: **88.8 MB** · **Reduction**: **41.8%**
...
- **Platform**: macOS · **Architecture**: Apple Silicon · **Recommended file**: `mac-arm64.dmg`
- **Platform**: macOS · **Architecture**: Intel · **Recommended file**: `mac-x64.dmg`
- **Platform**: Windows 10/11 · **Architecture**: x64 · **Recommended file**: `win-x64.exe`
- **Platform**: Windows 10/11 · **Architecture**: x64 portable · **Recommended file**: `win-x64.zip`
