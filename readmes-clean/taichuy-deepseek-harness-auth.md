...
### 环境变量 · 默认值 · 说明
- **环境变量**: `DSH_AUTH_HOST` · **默认值**: `0.0.0.0` · **说明**: 公共认证代理监听地址
- **环境变量**: `DSH_AUTH_PORT` · **默认值**: `3080` · **说明**: 公共认证代理端口
- **环境变量**: `DSH_AUTH_PUBLIC_URL` · **默认值**: 空 · **说明**: 输出使用的公开 HTTP(S) URL
- **环境变量**: `DSH_AUTH_STATE_DIR` · **默认值**: `$DSH_HOME/auth` · **说明**: 账号、哈希和白名单目录
- **环境变量**: `DSH_AUTH_MAX_ATTEMPTS` · **默认值**: `6` · **说明**: 锁定前最大失败次数
- **环境变量**: `DSH_AUTH_LOCK_SECONDS` · **默认值**: `30` · **说明**: 锁定秒数
- **环境变量**: `DSH_AUTH_SESSION_TTL_SECONDS` · **默认值**: `86400` · **说明**: 会话有效秒数
- **环境变量**: `DSH_AUTH_CAPTCHA_MODE` · **默认值**: `off` · **说明**: `off`、`always`、`after-failures`
- **环境变量**: `DSH_AUTH_CAPTCHA_AFTER_FAILURES` · **默认值**: `3` · **说明**: 失败后验证码的触发次数
- **环境变量**: `DSH_AUTH_SECURE_COOKIE` · **默认值**: `false` · **说明**: 是否给 Cookie 添加 `Secure`
- **环境变量**: `DSH_AUTH_TRUSTED_PROXIES` · **默认值**: 空 · **说明**: 逗号分隔的代理 IP/CIDR
