...
![DshCockpit 交流群二维码](b5f31d11d2c10688d6dcb8dc24fc39c8.jpg)
...
- 关闭窗口 · **浏览器版 `dsh web`**: ❌ 会话就断 · **其他桌面壳**: ✅ 托盘常驻 · ****DshCockpit****: ✅ 托盘常驻 + 后台任务照跑
- 运行时更新 · **浏览器版 `dsh web`**: ❌ 手动 npm · **其他桌面壳**: ❌ 无 · ****DshCockpit****: ✅ **自动更新管道 + 冒烟守卫 + 一键回滚**
- Token 用量 · **浏览器版 `dsh web`**: ❌ 只闪一下 · **其他桌面壳**: ❌ 无 · ****DshCockpit****: ✅ **实时胶囊 + 上下文压力预警**
- 花费多少 · **浏览器版 `dsh web`**: ❌ 不知道 · **其他桌面壳**: ❌ 无 · ****DshCockpit****: ✅ **成本中心：按天/周/月/工作区统计 + 预算报警**
- 随手提问 · **浏览器版 `dsh web`**: ❌ 要开浏览器 · **其他桌面壳**: ❌ 无 · ****DshCockpit****: ✅ **全局热键 Quick Ask（后台运行）**
- 定时任务 · **浏览器版 `dsh web`**: ❌ 无 · **其他桌面壳**: ❌ 无 · ****DshCockpit****: ✅ **壳级定时任务（间隔/每天 + 通知）**
- 历史检索 · **浏览器版 `dsh web`**: ❌ 手动翻 · **其他桌面壳**: ❌ 无 · ****DshCockpit****: ✅ **`Ctrl+K` 全文搜索全部会话**
- 数据安全 · **浏览器版 `dsh web`**: ✅ 本地 · **其他桌面壳**: ✅ 本地 · ****DshCockpit****: ✅ 本地 + **自动备份 + 隐私声明 + 备份不含密钥**
...
![DshCockpit main window — DeepSeek Harness (dsh) desktop cockpit with token usage capsule](photo/preview-1.png)

![Cost center — token cost tracking & budget alerts](photo/preview-2.png)
![Settings & plugin marketplace](photo/preview-3.png)
