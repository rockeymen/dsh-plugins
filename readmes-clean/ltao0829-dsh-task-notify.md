...
### 开关 · 默认 · 说明
- **开关**: 启用提醒 · **默认**: 开 · **说明**: 总开关
- **开关**: 对话任务完成提醒 · **默认**: 开 · **说明**: agent 一轮任务结束时提醒
- **开关**: 后台任务完成提醒 · **默认**: 开 · **说明**: 后台命令 / 子代理作业结束时提醒
- **开关**: 需要审核时提醒 · **默认**: 开 · **说明**: 运行中等待审批 / 计划评审 / 提问时提醒
- **开关**: 失败时提醒 · **默认**: 开 · **说明**: 对话报错 / 后台任务失败或被终止时提醒
- **开关**: 浏览器系统通知 · **默认**: 开 · **说明**: 发送操作系统通知（需授权）
- **开关**: 提示音 · **默认**: 关 · **说明**: 额外播放提示音
