![MoodBall](docs/assets/moodball-logo.png)

# MoodBall（心情球）

  macOS 桌面悬浮呼吸灯 —— 让 Agent 状态可见于整个桌面
...
### 菜单项 · 功能
- **菜单项**: 状态文字 · **功能**: 当前连接状态与状态名（如「已连接 · 工具调用」）
- **菜单项**: 隐藏 / 显示悬浮球 · **功能**: 开关悬浮球显示
- **菜单项**: 设置… · **功能**: 打开设置面板
- **菜单项**: 退出 · **功能**: 退出 app（不影响 DSH 本体）
...
### 状态 · 心情球 · 颜色
- **状态**: 空闲 · **心情球**: ![空闲](docs/assets/moodball-idle.png?v=2) · **颜色**: 蓝色
- **状态**: 正在思考中 · **心情球**: ![正在思考中](docs/assets/moodball-waiting.png?v=2) · **颜色**: 绿色
- **状态**: 工具调用 · **心情球**: ![工具调用](docs/assets/moodball-jumping.png?v=2) · **颜色**: 紫色
- **状态**: 等待你的授权 · **心情球**: ![等待你的授权](docs/assets/moodball-authorizing.png?v=2) · **颜色**: 黄色
- **状态**: 做出你的抉择 · **心情球**: ![做出你的抉择](docs/assets/moodball-questioning.png?v=2) · **颜色**: 粉色
- **状态**: 搞定啦 · **心情球**: ![搞定啦](docs/assets/moodball-done.png?v=2) · **颜色**: 青色
- **状态**: 出错了 · **心情球**: ![出错了](docs/assets/moodball-failed.png?v=2) · **颜色**: 红色
- **状态**: 停止 / 中断 · **心情球**: ![停止 / 中断](docs/assets/moodball-stopped.png?v=2) · **颜色**: 黑色
- **状态**: 未连接 / 插件未装 · **心情球**: ![未连接](docs/assets/moodball-disconnected.png?v=2) · **颜色**: 灰色
