...
- **Feature**: List skills / MCP (enabled state, scope) · **CLI**: ✅ · **Settings UI**: ✅
- **Feature**: Create / edit / delete skills · **CLI**: ✅ · **Settings UI**: ✅ (form + Markdown body)
- **Feature**: Enable / disable skills & MCP · **CLI**: ✅ · **Settings UI**: ✅
- **Feature**: Create / edit / delete MCP (stdio / streamable-http) · **CLI**: ✅ · **Settings UI**: ✅
- **Feature**: Import skills & MCP from Claude / Codex and other tools · **CLI**: ✅ · **Settings UI**: ✅
- **Feature**: Project-scope install with folder picker · **CLI**: ✅ (`folder` cmd) · **Settings UI**: ✅ (DSH directory picker)
- **Feature**: Manage plugins (official vs other, enable / disable / uninstall) · **CLI**: — · **Settings UI**: ✅
- **Feature**: Plugin Market: curated store (npm install) + GitHub search · **CLI**: — · **Settings UI**: ✅
- **Feature**: Check & update third-party plugins · **CLI**: — · **Settings UI**: ✅
- **Feature**: [dsh-myrules](https://github.com/Relistencode/dsh-extension-hub/blob/main/packages/dsh-myrules/README.md) — edit host-wide global instructions (Customize page); search "dsh-myrules" in the plugin manager to disable or uninstall it · **CLI**: — · **Settings UI**: ✅
- **Feature**: Add-on manager: install / disable / uninstall companion features, update together with the main plugin · **CLI**: — · **Settings UI**: ✅
...
### Source · Skills · MCP
- **Source**: **Claude** · **Skills**: `<repo>/.claude/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` · **MCP**: `<repo>/.mcp.json`, `~/.claude.json`, `~/.claude/.claude.json`
- **Source**: **Codex** · **Skills**: `<repo>/.codex/skills/*/SKILL.md`, `~/.codex/skills/*/SKILL.md` · **MCP**: `~/.codex/config.toml`, `<repo>/.codex/config.toml`
