# ForkProbe：AI Skill 选型与试跑工具
    ...
    ![forkprobe 发布页截图](./docs/assets/forkprobe-homepage-zh.png)
...
- **场景**: 学术润色与 SCI 写作 · **状态**: 已支持 · **Report 里看到什么**: 多版本文本、AI 评审、winner 选择 · **推荐候选**: `baseline`, `research-paper-writing-skills`, `paper-writer-skill`, [`nature-polishing`](https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-polishing), `humanizer`, `academic-humanizer`
- **场景**: 自然化与风格改写 / 去 AI 味写作 · **状态**: 已支持 · **Report 里看到什么**: 不同风格稿件并排比较 · **推荐候选**: `baseline`, `writing-anti-ai`, [`Humanizer-zh`](https://github.com/op7418/Humanizer-zh), [`humanizer`](https://github.com/blader/humanizer), [`stop-slop`](https://github.com/hardikpandya/stop-slop), [`avoid-ai-writing`](https://github.com/conorbronsdon/avoid-ai-writing), [`remove-ai-flavor-writing-skill`](https://github.com/B1lli/remove-ai-flavor-writing-skill)
- **场景**: 审稿回复与投稿材料 · **状态**: 已支持 · **Report 里看到什么**: 回复草稿、结构、语气对比 · **推荐候选**: `baseline`, [`nature-response`](https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-response), `paper-writer-skill`, `writing-anti-ai`, `research-paper-writing-skills`
- **场景**: PPTX 成品生成 · **状态**: 已支持 · **Report 里看到什么**: 可打开的 PPTX、预览图、候选说明 · **推荐候选**: `baseline + presentations`, [`nature-paper2ppt`](https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-paper2ppt) `+ presentations`, [`academic-pptx-skill`](https://github.com/Gabberflast/academic-pptx-skill) `+ presentations`, [`ppt-master`](https://github.com/hugohe3/ppt-master), [`md-slides`](https://github.com/zl190/md-slides)
- **场景**: 论文作图 / 科研绘图 · **状态**: 已支持 · **Report 里看到什么**: PNG 预览、SVG/PDF/TIFF、代码、caption、QA · **推荐候选**: `baseline-python-figure`, [`scientific-visualization`](https://github.com/K-Dense-AI/scientific-agent-skills/tree/main/skills/scientific-visualization) `+ Python/SVG renderer`, [`nature-figure`](https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-figure) `+ Python/SVG renderer`, `plot-code-python`, `schematic-svg`, `graphical-abstract-svg`
- **场景**: 调研报告 / Research report · **状态**: 已支持 · **Report 里看到什么**: 报告预览、sources.json、evidence table、claim checks、limitations、AI 评审 · **推荐候选**: `baseline-research-report`, `source-first-research`, `analyst-style-report`, `evidence-table-report`, `company-research-report`, [`user-research-cookiy`](https://github.com/cookiy-ai/user-research-skill) `+ report package`
- **场景**: 图片生成 / 生图比较 · **状态**: 规划中 · **Report 里看到什么**: 图片预览、文件链接、候选说明 · **推荐候选**: 暂不放固定候选；未来支持 image-generation pipelines
- **场景**: 网页 / HTML 制作比较 · **状态**: 已支持 · **Report 里看到什么**: 可运行页面链接、桌面/移动端截图、QA、源码、AI 评审 · **推荐候选**: `baseline-web`, [`Anthropic frontend-design`](https://github.com/anthropics/skills/tree/main/skills/frontend-design), [`Hallmark`](https://github.com/Nutlope/hallmark), [`web-artifacts-builder`](https://github.com/anthropics/skills/tree/main/skills/web-artifacts-builder), [`ui-ux-pro-max`](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill), [`web-design-engineer`](https://github.com/ConardLi/garden-skills/tree/main/skills/web-design-engineer), [`baoyu-design`](https://github.com/JimLiu/baoyu-design)
- **场景**: 产品宣传片成品比较 · **状态**: 已支持 · **Report 里看到什么**: MP4 播放、封面、字幕、脚本、分镜、源码、媒体 QA、AI 评审 · **推荐候选**: `baseline-remotion-agent`, [`HyperFrames product-launch-video`](https://github.com/heygen-com/hyperframes), [`video-shotcraft`](https://github.com/Vincentwei1021/video-shotcraft)
- **场景**: 动效视频成品比较 · **状态**: 已支持 · **Report 里看到什么**: MP4 播放、动效规格、源码、时长/分辨率、媒体 QA、AI 评审 · **推荐候选**: `baseline-remotion-motion`, [`HyperFrames motion-graphics`](https://github.com/heygen-com/hyperframes), [`Remotion Bits`](https://github.com/av/remotion-bits)
- **场景**: 口播粗剪比较 · **状态**: 已支持 · **Report 里看到什么**: 粗剪 MP4、字幕、转写稿、剪辑清单/时间线、压缩时长、媒体 QA · **推荐候选**: [`auto-editor`](https://github.com/WyattBlue/auto-editor), [`video-editing-skill`](https://github.com/maxazure/video-editing-skill), [`video-use`](https://github.com/browser-use/video-use) `cut-only`, [`chengfeng-videocut`](https://github.com/Agentchengfeng/chengfeng-videocut-skills)（实验）
