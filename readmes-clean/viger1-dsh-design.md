...
- **Without the plugin**: ![Baseline: centered blue SaaS pricing page](docs/demo-baseline.png) · **With the skill + audit loop**: ![Guided: warm off-white editorial pricing page](docs/demo-guided.png)

### Measured at 1280px · Without · With
- **Measured at 1280px**: Violations · **Without**: **4** · **With**: **0**
- **Measured at 1280px**: Distinct type sizes · **Without**: 11 — `12 13 14 15 16 17 19 20 30 44 46` · **With**: 6 — `14 16 20 24 32 40`
- **Measured at 1280px**: Off-grid spacing values · **Without**: 10 — `5 6 10 13 14 15 18 26 30 226` · **With**: 0
- **Measured at 1280px**: Tap targets under 24px · **Without**: 3 · **With**: 0
- **Measured at 1280px**: Generated-design tells · **Without**: 1 — a violet gradient on the logo mark · **With**: 0
- **Measured at 1280px**: Non-neutral colors · **Without**: 3 · **With**: 5
- **Measured at 1280px**: Elements sampled · **Without**: 71 · **With**: 78
...
- **Rule**: `contrast` · **What it reports**: Every text element failing WCAG AA, with its measured ratio and the ratio it needed. Text alpha is composited against the real backdrop, so faded grey-on-white is caught.
- **Rule**: `type-scale` · **What it reports**: How many distinct text sizes the page actually rendered, and which. More than a handful means the hierarchy was improvised.
- **Rule**: `spacing-grid` · **What it reports**: Padding, margin, and gap values that miss the spacing scale, listed by value and element.
- **Rule**: `palette` · **What it reports**: Distinct non-neutral colors. A grey ramp is free; nine accents is drift.
- **Rule**: `tap-target` · **What it reports**: Interactive elements below the 44px floor, with their measured size.
- **Rule**: `line-length` · **What it reports**: Running text past the comfortable measure, with the longest line found.
- **Rule**: `default-font` · **What it reports**: Whether most text fell back to the browser default, meaning no family was ever chosen.
- **Rule**: `purple-gradient` · **What it reports**: Violet-to-fuchsia gradients, detected by **hue** rather than by string — Tailwind's `violet-500` sits at 258°, so a naive 260° band would miss the most common offender.
- **Rule**: `emoji-icons` · **What it reports**: Emoji standing in for iconography inside controls.
...
- **Plugin**: [dsh-preview](https://github.com/Viger1/dsh-preview) · **What it gives your agent**: 👁 Eyes — verify what it builds: open, read, screenshot, self-check
- **Plugin**: [dsh-pilot](https://github.com/Viger1/dsh-pilot) · **What it gives your agent**: ✋ Hands — operate any page by accessibility refs, with a native permission model
- **Plugin**: [dsh-review](https://github.com/Viger1/dsh-review) · **What it gives your agent**: 🔍 Judgement — find defects, then try to refute each one before reporting it
- **Plugin**: **dsh-design** (this repo) · **What it gives your agent**: 🎨 Taste — constrain the choices, then measure whether the result kept them