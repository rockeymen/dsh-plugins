...
###  · YouTube Shorts · B站竖屏
- 播放方式 · **YouTube Shorts**: 官方 iframe embed · **B站竖屏**: **原生 mp4 `<video>`**（经宿主代理，Range 可拖进度）
- 内容获取 · **YouTube Shorts**: 匿名搜索页（shorts 过滤器） · **B站竖屏**: 匿名搜索 + **竖屏预检**（并发 view 确认 9:16，横版自动过滤）
- 自动连播 · **YouTube Shorts**: 播完事件 + 看门狗双保险 · **B站竖屏**: 原生事件（最稳）
- 续批 · **YouTube Shorts**: 关键词重搜去重追加 · **B站竖屏**: 分页续批
...
### 浮窗模式 · 贴边模式 · 最小化
- **浮窗模式**: ![浮窗模式](docs/screenshot-float.png) · **贴边模式**: ![贴边模式](docs/screenshot-stick.png) · **最小化**: ![最小化](docs/screenshot-minimized.png)
