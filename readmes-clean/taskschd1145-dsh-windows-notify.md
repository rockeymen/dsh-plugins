...
### 文件 · 说明
- **文件**: `index.mjs` · **说明**: 插件源码（ESM Cordis 插件，当前版本 v6）
- **文件**: `icon.png` · **说明**: 通知图标源（256×256，Toast appLogoOverride 直接引用）
- **文件**: `icon.ico` · **说明**: 快捷方式图标（由 icon.png 自动生成，勿手动编辑）
- **文件**: `cordis.patch.yml` · **说明**: 机器级挂载补丁（实际安装位置为 `%USERPROFILE%\.dsh\cordis.patch.yml`）
