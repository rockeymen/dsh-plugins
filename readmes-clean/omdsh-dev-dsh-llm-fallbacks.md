...
### Doc · Content
- **Doc**: [docs/install.md](docs/install.md) · **Content**: profile install / registry install / uninstall / `--dump-config` verification
- **Doc**: [docs/release.md](docs/release.md) · **Content**: release process: Trusted Publishing setup, Release prep SOP, fragment format, rollback
- **Doc**: [docs/configuration.md](docs/configuration.md) · **Content**: full `fallbacks` namespace reference, selector syntax, example YAML, plugin-config card usage, behavior notes
- **Doc**: [docs/consumer-api.md](docs/consumer-api.md) · **Content**: developer consumption contract: export inventory, minimal examples, lifecycle, typing
- **Doc**: [docs/verification.md](docs/verification.md) · **Content**: verification records (test matrix, bundle layer order, runtime contracts, QA gate script)