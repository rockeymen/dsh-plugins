...
- **我想要……**: 在开发对话里直接检查和操作当前网页 · **推荐从这里开始**: [dsh-browser-bridge](https://github.com/ycp424c/dsh-browser-bridge) · **为什么**: 把完整 DSH Web 嵌进 Chrome 侧边栏，按 prompt 显式授权当前标签页，DSH 能在同一对话里读取 DOM、样式、console 报错并操作页面，无需另开浏览器专用对话。
...
### # · 项目 · ⭐ Stars · License
- **#**: 1 · **项目**: [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) · **⭐ Stars**: 1785 · **License**: Apache-2.0
- **#**: 2 · **项目**: [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) · **⭐ Stars**: 1266 · **License**: MIT
- **#**: 3 · **项目**: [liustack/modlens](https://github.com/liustack/modlens) · **⭐ Stars**: 1208 · **License**: MIT
- **#**: 4 · **项目**: [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) · **⭐ Stars**: 835 · **License**: MIT
- **#**: 5 · **项目**: [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) · **⭐ Stars**: 709 · **License**: MIT
- **#**: 6 · **项目**: [Small-tailqwq/dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) · **⭐ Stars**: 538 · **License**: —
- **#**: 7 · **项目**: [Nagi-ovo/dsh-ads](https://github.com/Nagi-ovo/dsh-ads) · **⭐ Stars**: 321 · **License**: —
- **#**: 8 · **项目**: [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) · **⭐ Stars**: 308 · **License**: MIT
- **#**: 9 · **项目**: [morluto/rea](https://github.com/morluto/rea) · **⭐ Stars**: 308 · **License**: MIT
- **#**: 10 · **项目**: [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) · **⭐ Stars**: 231 · **License**: MIT
- **#**: 11 · **项目**: [Electricitysheep/dsh-handbook](https://github.com/Electricitysheep/dsh-handbook) · **⭐ Stars**: 181 · **License**: —
- **#**: 12 · **项目**: [hust-open-atom-club/oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) · **⭐ Stars**: 163 · **License**: MIT
- **#**: 13 · **项目**: [huiliyi37/dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) · **⭐ Stars**: 132 · **License**: Apache-2.0
...
### 项目 · 简介 · 创建日期
- **项目**: [mbj733/dsh-hermes-memory](https://github.com/mbj733/dsh-hermes-memory) · **简介**: DSH (DeepSeek Harness) agent preset + plugin: Hermes-style cross-session memory & autonomous skill learning. · **创建日期**: 2026-08-14
- **项目**: [SnowAmberX/dsh-role-router](https://github.com/SnowAmberX/dsh-role-router) · **简介**: Role-based model routing plugin for DeepSeek Harness: planner/subagent roles plus a settings card and composer summary · **创建日期**: 2026-08-14
- **项目**: [Yee-h/dsh-zen-proxy](https://github.com/Yee-h/dsh-zen-proxy) · **简介**: dsh plugin: in-process proxy that injects official OpenCode Zen client headers, enabling Zen free models in dsh without the 429 FreeUsageLimitError · **创建日期**: 2026-08-14
- **项目**: [khiqwq/dsh-credentials-system](https://github.com/khiqwq/dsh-credentials-system) · **简介**: System-bound encrypted credential provider for DeepSeek Harness · **创建日期**: 2026-08-14
- **项目**: [CodePrometheus/dsh-observability](https://github.com/CodePrometheus/dsh-observability) · **简介**: Observability for DeepSeek Harness (dsh), use the OpenTelemetry Protocol · **创建日期**: 2026-08-14
- **项目**: [mixin-ai/dsh-file-changes](https://github.com/mixin-ai/dsh-file-changes) · **简介**: DeepSeek Harness web plugin: per-turn file-change panel with diff viewing and filesystem reveal · **创建日期**: 2026-08-14
- **项目**: [pineapple880066/dsh-desktop-pets](https://github.com/pineapple880066/dsh-desktop-pets) · **简介**: Codex-style desktop pets for DeepSeek Harness (dsh-plugin) · **创建日期**: 2026-08-14
- **项目**: [sherconan/dsh-web-recon](https://github.com/sherconan/dsh-web-recon) · **简介**: 网页系统侦察 · DeepSeek Harness 插件：摸清一个网页系统怎么运作，只摸一次。抓真实接口与可访问性树，固化成可复用的作战手册。零依赖，不用 Playwright。 · **创建日期**: 2026-08-14
...
- **[dsh-session-deeplink](https://github.com/R3alloc/dsh-session-deeplink)**（[@R3alloc](https://github.com/R3alloc) · 2026-08-14）— 为每个会话生成可复用的 `/?session=` 深链接：地址栏随会话同步，链接可收藏、分享，刷新后恢复目标会话；纯浏览器端实现，不增加 host 服务。
...
- **剔除蹭热度条目：** 带 `dsh-plugin` Topic 但并非 DSH 插件的仓库（平台本体、其他 Agent 工具、同名目录站等）不计入目录与榜单，理由逐条记录在 [data/curated.json