...
![](https://github.com/user-attachments/assets/22782828-09f0-4031-be19-4c2e234556ad)
...
dsh-skill add                             # 添加到全局（单个 .md 或含顶层 SKILL.md 的目录束）
dsh-skill add  --workspace D:\项目A       # 直接添加到指定工作区
