...
### 阶段 · 做什么 · 产出
- **阶段**: 1. 想法验证 · **做什么**: 调研市场/竞品/可行性，确认值不值得做 · **产出**: 想法验证结论
- **阶段**: 2. 产品定义与需求 · **做什么**: 产品定位 + 逐条需求（带验收标准） · **产出**: 产品定义 + PRD
- **阶段**: 3. 技术设计 · **做什么**: 技术方案与任务拆分 · **产出**: 技术设计 + 任务清单
- **阶段**: 4. 开发与质量 · **做什么**: 开发实现 + 测试 + 安全审计 · **产出**: 代码 + 审计报告
- **阶段**: 5. 发布与部署 · **做什么**: 整理可分发产物（符合 GitHub 规范）+ 部署上线 · **产出**: README / 版本 / Release / 部署验证
- **阶段**: 6. 宣传与冷启动 · **做什么**: 首发包（视频脚本/文章/渠道） · **产出**: 宣传材料
- **阶段**: 7. 运营与增长 · **做什么**: 数据看板、反馈渠道、增长动作 · **产出**: 运营方案
- **阶段**: 8. 迭代与维护 · **做什么**: 反馈池、路线图，完成后循环进入下一轮 · **产出**: 迭代路线图
