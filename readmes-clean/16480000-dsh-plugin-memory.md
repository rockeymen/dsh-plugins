...
- **Key**: `autoDistill` · **Type**: boolean · **Default**: `true` · **Meaning**: Distill completed turns automatically.
- **Key**: `memoryDir` · **Type**: string · **Default**: `<DSH_HOME>/memory` · **Meaning**: Memory directory.
- **Key**: `distillProvider` · **Type**: string · **Default**: session route · **Meaning**: Explicit distill provider; must pair with `distillModel`.
- **Key**: `distillModel` · **Type**: string · **Default**: session route · **Meaning**: Explicit distill model; must pair with `distillProvider`.
- **Key**: `maxTokens` · **Type**: number · **Default**: `3000` · **Meaning**: Output token cap per distill or fusion call.
