...
### Agent · 项目级 · 用户级
- **Agent**: DeepSeek Harness · **项目级**: `/.dsh/skills/`（rank 100）或 `/.agents/skills/`（rank 200） · **用户级**: `~/.dsh/skills/`（rank 400）
- **Agent**: Claude Code · **项目级**: `/.claude/skills/` · **用户级**: `~/.claude/skills/`
- **Agent**: Codex · **项目级**: `/.codex/skills/` · **用户级**: `~/.codex/skills/`
- **Agent**: VS Code Copilot · **项目级**: `/.agents/skills/` · **用户级**: `~/.agents/skills/`
- **Agent**: 其它兼容 agent · **项目级**: 按该 agent 的技能目录约定 · **用户级**: 同上
