...
### Stars · Repo · Description / 描述
- **Stars**: ⭐ 2778 · **Repo**: [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) · **Description / 描述**: Electron desktop app deeply adapted for macOS & Windows — best out-of-the-box DSH experience. / 深度适配 macOS 和 Windows 的 Electron 桌面端，最佳开箱即用体验。
...
- **Stars**: ⭐ 194 · **Repo**: [dataelement/dsh-desktop](https://github.com/dataelement/dsh-desktop) · **Description / 描述**: Desktop for DeepSeek Harness. / DeepSeek Harness 桌面客户端。
...
- **Stars**: ⭐ 2 · **Repo**: [HaoyueQin/deepseek-harness-desktop](https://github.com/HaoyueQin/deepseek-harness-desktop) · *