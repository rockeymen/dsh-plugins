...
- **Plugin**: [`deepseek-idesign`](https://www.npmjs.com/package/deepseek-idesign) · **Best for**: Websites, app prototypes, posters, cards, data reports, magazines, and other non-slide designs · **Main capabilities**: Curated Design templates, desktop/mobile preview, direct element editing, themes and design tokens, selection-aware Ask AI
- **Plugin**: [`deepseek-ippt`](https://www.npmjs.com/package/deepseek-ippt) · **Best for**: Presentations and slide decks · **Main capabilities**: Dedicated slide templates, page-by-page editing, visual refinement, selection-aware Ask AI, PDF/PPTX export
- **Plugin**: [`deepseek-ivideo`](https://www.npmjs.com/package/deepseek-ivideo) · **Best for**: Motion design, product demos, data stories, and short video · **Main capabilities**: HyperFrames timeline, animation and media, 27 Video templates, selection-aware Ask AI, validation, and video export
