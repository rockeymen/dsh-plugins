...
- **Variable**: `CODEX_TASKBOARD_HOST` · **Default**: `0.0.0.0` · **Purpose**: HTTP bind address; use `127.0.0.1` to disable LAN access
- **Variable**: `CODEX_TASKBOARD_PORT` · **Default**: `47823` · **Purpose**: Local HTTP port
- **Variable**: `CODEX_TASKBOARD_DATA_DIR` · **Default**: `.data` · **Purpose**: SQLite data directory
- **Variable**: `CODEX_TASKBOARD_URL` · **Default**: `http://127.0.0.1:47823` · **Purpose**: CLI API origin
