![Mirage: A Unified Virtual File System for AI Agents](assets/mirage-og-light@2x.png)
...
## Architecture
    ...
    ![Mirage architecture: AI Agent and Application → Mirage Bash and VFS → Dispatcher & Cache → Infrastructure and Remote](assets/mirage-arch-light.svg)
