...
### 字体 · 用途 · 获取方式
- **字体**: Anthropic Sans Web Text · **用途**: 界面 · **获取方式**: 仓库 [`fonts/`](fonts/) 下载，或从 Claude 应用提取
- **字体**: Anthropic Serif Web Text · **用途**: 模型对话 · **获取方式**: 仓库 [`fonts/`](fonts/) 下载，或从 Claude 应用提取
- **字体**: Anthropic Mono Variable · **用途**: 代码 · **获取方式**: 仓库 [`fonts/`](fonts/) 下载，或从 Claude 应用提取
