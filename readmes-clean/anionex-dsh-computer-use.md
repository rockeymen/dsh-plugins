...
```
  ...
  ![The never-active deterministic native fixture before target-process pointer input, showing the dedicated pointer probe and ready status.](assets/computer-use-fixture.png)
