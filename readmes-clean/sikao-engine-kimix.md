...
Every user/assistant message is automatically indexed by **BM25 inverted index** (N-gram, n=2) on append, persisted to `<session>/history_index/.json`, and survives process restarts. Cap at 500 rounds; oldest evicted automatically.
