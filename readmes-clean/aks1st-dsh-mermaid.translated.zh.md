...
- **亮色主题 · 会话内（未放大）**: ![亮色主题会话内渲染](assets/main-page-white.png) · **暗色主题 · 会话内（未放大）**: ![暗色主题会话内渲染](assets/main-page-dark.png)

### 亮色主题 · 放大浮层 · 暗色主题 · 放大浮层
- **亮色主题 · 放大浮层**: ![亮色主题放大浮层](assets/fangda-white.png) · **暗色主题 · 放大浮层**: ![暗色主题放大浮层](assets/fangda-dark.png)
...
### 配置项 · 默认值 · 说明
- **配置项**: `theme` · **默认值**: `auto` · **说明**: 图表主题：`auto`（跟随亮/暗）、`default`、`dark`、`neutral`、`forest`、`base`
- **配置项**: `maxTextSize` · **默认值**: 50000 · **说明**: 单图文本上限（防超大图拖垮渲染）
- **配置项**: `maxEdges` · **默认值**: 2000 · **说明**: 边数守卫
- **配置项**: `securityLevel` · **默认值**: `strict` · **说明**: 固定为 `strict`，不接受 `loose`
