...
### 模式 · 执行器 · 适用场景
- **模式**: **LLM** · **执行器**: OpenAI、Anthropic 等 · **适用场景**: 对话助手、问答、内容生成
- **模式**: **CLI Agent** · **执行器**: 容器中的 OpenCode、Claude Code、Codex · **适用场景**: Computer Use、沙箱隔离、SKILL 生态
- **模式**: **纯 Hook** · **执行器**: 你自己的 TypeScript 代码 · **适用场景**: 确定性逻辑、菜单路由、无需 AI 的业务流程
