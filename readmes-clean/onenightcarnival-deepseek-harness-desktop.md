...
- `splash.html` — 启动等待页。
- `stage-dsh.mjs` — 把 `@deepseek-ai/dsh` 安装进 `staging/-<arch>/dsh`
...
[dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) 的四个
生产力插件：任务看板、Git 图谱、右侧预览面板、SSH 远程连接，
...
- 菜单「插件 → 配置中心…」左侧导航分三页：**插件**（按 npm 包名/来源
