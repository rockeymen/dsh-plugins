...
- **Agent activity**: Turn running · **Whale reaction**: swims fast 🏊
- **Agent activity**: Model streaming · **Whale reaction**: thinks along, thought bubble 💭
- **Agent activity**: Tool call · **Whale reaction**: blows a bubble with a friendly label (敲命令 / 读文件 / …)
- **Agent activity**: Turn finishes · **Whale reaction**: speaks up: "搞定! 3 分 12 秒,跑了 8 个工具,改了 5 个文件"
- **Agent activity**: Approval waiting · **Whale reaction**: taps the glass; the browser tab title flashes 🔔
- **Agent activity**: Context filling · **Whale reaction**: eats; past 84% it sinks 📉
- **Agent activity**: Idle 5 min · **Whale reaction**: asks for work ("我闲着呢,有活吗?")
- **Agent activity**: 10 min idle / late night · **Whale reaction**: sleeps, or wears a nightcap 🌙
- **Agent activity**: **Approval requested** · **Whale reaction**: **presses against the glass, taps, amber pulse** 🔔
- **Agent activity**: Turn completed · **Whale reaction**: jumps with a flip and foam confetti 🎉
- **Agent activity**: Turn failed · **Whale reaction**: sinks, eyes flatline 😢
- **Agent activity**: Context ~62% / ~82% full · **Whale reaction**: feeding time — "还能吃一点 / 吃饱了" 🍤
- **Agent activity**: Idle 10 minutes · **Whale reaction**: dozes off 💤
- **Agent activity**: 00:00–06:00 local · **Whale reaction**: nightcap 🌙
- **Agent activity**: You click / double-click it · **Whale reaction**: squeak / startled flail (with sound)
