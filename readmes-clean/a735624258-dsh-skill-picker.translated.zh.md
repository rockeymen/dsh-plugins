...
- 触发 · **官方 `/` 补全**: 输入框打 `/` · **dsh-skill-picker**: 输入框旁 ⚡ 按钮
- 查找方式 · **官方 `/` 补全**: 前缀记忆驱动，**忘了名字就找不到** · **dsh-skill-picker**: 全列表浏览 + 关键字搜索，**忘了名字也能翻到**
- 排序 · **官方 `/` 补全**: 固定 · **dsh-skill-picker**: **最近使用置顶、常用靠前**
- 描述可见 · **官方 `/` 补全**: 精简 · **dsh-skill-picker**: 完整描述一眼看全
...
###  · 官方 `/` 补全 · dsh-skill-picker
- 触发 · **官方 `/` 补全**: 输入框打 `/` · **dsh-skill-picker**: 输入框旁 ⚡ 按钮
- 查找方式 · **官方 `/` 补全**: **前缀记忆驱动**——需要先记得技能名才能打出来 · **dsh-skill-picker**: **全列表浏览 + 关键字搜索**——忘了名字也能翻到
- 排序 · **官方 `/` 补全**: 固定顺序 · **dsh-skill-picker**: 最近使用置顶、常用靠前（localStorage）
- 适合场景 · **官方 `/` 补全**: 记得名字的老手 · **dsh-skill-picker**: 技能多、记不全名字、想翻着选的人
