...
### 你真正想知道的 · 装之前
- **你真正想知道的**: 余额还能用几天？ · **装之前**: 只有一个余额数字
- **你真正想知道的**: 今天花了多少？这个月呢？ · **装之前**: 只有「累计」，没有时间感
- **你真正想知道的**: 钱花在哪个模型上？ · **装之前**: 不知道
- **你真正想知道的**: 缓存到底帮我省了多少？ · **装之前**: 完全看不到
- **你真正想知道的**: 8-17 涨价后我的账单会变成多少？ · **装之前**: 只能自己算
...
- **模型**: deepseek-v4-pro · **时段**: 08-17 前固定 · **输入·缓存命中**: 0.025 · **输入·未命中**: 3 · **输出**: 6
- **模型**: deepseek-v4-pro · **时段**: 高峰 / 闲时 · **输入·缓存命中**: 0.3 / 0.15 · **输入·未命中**: 9 / 4.5 · **输出**: 27 / 13.5
- **模型**: deepseek-v4-flash · **时段**: 08-17 前固定 · **输入·缓存命中**: 0.02 · **输入·未命中**: 1 · **输出**: 2
- **模型**: deepseek-v4-flash · **时段**: 高峰 / 闲时 · **输入·缓存命中**: 0.1 / 0.05 · **输入·未命中**: 3 / 1.5 · **输出**: 9 / 4.5
