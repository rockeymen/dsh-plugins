简体中文 ·
  ...
  ![Oh-DSH whale](./assets/dsh-whale.png)
  # Oh-DSH
  一套 DSH runtime，多种可独立安装的交互方式。

  ![Oh-DSH Desktop](./assets/oh-dsh-desktop-overview.png)
...
[dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) 上游插件，并保留完整署名。
  ...
  ![DeepSeek Harness 官方社区展示](./assets/oh-dsh-official-showcase.png)
