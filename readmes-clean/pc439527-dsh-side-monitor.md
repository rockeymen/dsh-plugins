...
### Data · Interval
- **Data**: CPU / memory / network / load / uptime · **Interval**: 2s
- **Data**: Disk · **Interval**: 10s (Host-side cache)
- **Data**: Process list · **Interval**: 3s (Host-side snapshot cache)
- **Data**: Docker list + stats · **Interval**: 5s (stats 3s cache)
...
Host Service (lib/collectors.js + lib/rpc.js)
  ...
  ├─ Process Collector  (procRoot//stat|status|cmdline, host-side search/sort/pagination, PPID included)
