...
### 能力 · 你得到什么
- **能力**: 精准批注 · **你得到什么**: 文字拖选，以及稳定的“双击内容块”后备方式
- **能力**: 多意见审阅 · **你得到什么**: 原文锚点、来源跳转、删除与整体意见
- **能力**: 响应式审阅栏 · **你得到什么**: 宽屏并排、中等宽度按需抽屉、手机端底部面板
- **能力**: DSH 响应闭环 · **你得到什么**: 通过现有 pending interaction 批准、要求修改或回到聊天
- **能力**: 草稿恢复 · **你得到什么**: 无插件服务器、无第三方服务的本地尽力恢复
- **能力**: 审阅保护 · **你得到什么**: 拒绝过期计划草稿；丢弃未发送意见前必须明确确认
- **能力**: 界面适配 · **你得到什么**: 中英文文案、键盘快捷键、响应式布局与 DSH 主题变量
...
### 计划类型 · 很适合批注的内容
- **计划类型**: 数据库或认证迁移 · **很适合批注的内容**: 兼容窗口、幂等迁移、回滚阈值、零停机顺序
- **计划类型**: 公共 API 重构 · **很适合批注的内容**: 契约保持、废弃路径、版本策略、移动端或 SDK 兼容
- **计划类型**: 安全变更 · **很适合批注的内容**: 信任边界、CSRF 与 secret 处理、审计证据、失败语义
- **计划类型**: 部署与灰度 · **很适合批注的内容**: Feature flag 阶段、可观测停止条件、负责人、回滚演练
- **计划类型**: 测试策略 · **很适合批注的内容**: 遗漏的失败场景、并发、重启恢复、回归与验收标准
