...
### 维度 · 选项 · 作用
- **维度**: **工作状态** · **选项**: 正常 · 计划 · **作用**: 立即完成任务，或进入官方 DSH 计划工作流。
- **维度**: **思考策略** · **选项**: 标准 · 第一性原理 · **作用**: 正常回答，或显式梳理目标、事实、假设、约束、推导和验证。
- **维度**: **质量门禁** · **选项**: 关 · 对抗性审查 · 验收审查 · **作用**: 不增加审查，独立寻找风险，或对照任务和已批准计划验收结果。
- **维度**: **自进化** · **选项**: 关 · 开 · **作用**: 自动分析会话，生成待人工审阅的规则提议，自动优化AGENTS.md（但不改动 AGENTS.md）
...
### 设置 · 默认值 · 说明
- **设置**: 自进化 · **默认值**: `Propose` · **说明**: 新会话和没有明确保存自进化选择的旧会话默认开启。
- **设置**: 学习批次 · **默认值**: `3` · **说明**: 每累计完成 3 次父 Agent 回复后启动一次学习。可在全局设置中调整为 `1..100`。
- **设置**: 待审阅提议上限 · **默认值**: `100` · **说明**: 超过上限时不会继续堆积提议，可在全局设置中调整为 `1..1000`。
- **设置**: 学习范围 · **默认值**: 已开启自进化的源会话 · **说明**: 不再配置项目范围；当前会话打开自进化，就会纳入学习范围。
- **设置**: 规则作用域 · **默认值**: 全局 · **说明**: 应用后的规则跨会话生效，不绑定项目目录。
...
### 你需要…… · 推荐组合 · 适合原因
- **你需要……**: 快速完成日常工作 · **推荐组合**: `正常 · 标准 · 关` · **适合原因**: 保持执行节奏，不增加额外流程。
- **你需要……**: 做高影响决策 · **推荐组合**: `计划 · 第一性原理 · 关` · **适合原因**: 先研究并暴露假设，再进入 DSH 的计划审批流程。
- **你需要……**: 有把握地交付实现 · **推荐组合**: `正常 · 标准 · 验收审查` · **适合原因**: 完成实现后，由独立审查 Agent 对照任务目标检查结果。
- **你需要……**: 挑战高风险答案 · **推荐组合**: `正常 · 第一性原理 · 对抗性审查` · **适合原因**: 显式展开推理，再寻找遗漏、反例、回归和缺少依据的结论。
- **你需要……**: 沉淀稳定的个人偏好 · **推荐组合**: `正常 · 标准 · 关 · 进化 开` · **适合原因**: 按默认每 3 次回复一批识别长期规则，只生成提议，不自动启用。
