...
### 面 · 内容
- **面**: 模型工具 ×4 · **内容**: `rank_plugins` 榜单查询 · `search_plugins` 检索 · `recommend_plugins` 按目标推荐 · `sync_registry` 刷新本地数据
- **面**: 设置页标签 · **内容**: 设置 → 插件 → 「**插件排行**」：完整排行榜，随 DSH 亮/暗主题自动适配
...
### 源 · 内容 · 用途
- **源**: GitHub Search API `topic:dsh-plugin` · **内容**: 全部公开仓库 + stars/更新时间/license/size 等 · **用途**: 主数据源
- **源**: [hub 目录公开镜像](https://github.com/0xsline/awesome-deepseek-harness) · **内容**: 官方精选目录与分类（hub 组织仓库私有，经每日镜像） · **用途**: 分类映射 + 生态信号
- **源**: 三个 awesome 列表 · **内容**: 社区人工精选 · **用途**: 生态信号
- **源**: npm registry（规划中） · **内容**: 下载量 · **用途**: 真实使用量信号
...
### 阶段 · 状态
- **阶段**: M1 数据管道 + 静态排行站 · **状态**: ✅
- **阶段**: M2 DSH 插件（工具 + 设置页标签） · **状态**: ✅ 真机验证通过
- **阶段**: M3 推荐逻辑升级 + 人工精选层 · **状态**: 🔨 规划中
- **阶段**: M4 生态运营（徽章 / 月度报告 / 安装量遥测） · **状态**: ⏳
