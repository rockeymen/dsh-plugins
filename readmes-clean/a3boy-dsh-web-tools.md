...
Uses the native DSH `web_search` / `web_fetch` tools.
  ...
  ![dsh-web-tools settings](assets/overview.png)
...
- **Provider**: [Tavily](https://tavily.com) · **Search**: ✅ · **Fetch**: ✅ · **Quota**: ✅
- **Provider**: [Exa](https://exa.ai) · **Search**: ✅ · **Fetch**: ✅ · **Quota**: —
- **Provider**: [Firecrawl](https://firecrawl.dev) · **Search**: ✅ · **Fetch**: ✅ · **Quota**: ✅
- **Provider**: [Parallel](https://parallel.ai) · **Search**: ✅ · **Fetch**: ✅ · **Quota**: Dashboard only
- **Provider**: [Brave Search](https://brave.com/search/api/) · **Search**: ✅ · **Fetch**: — · **Quota**: ✅
- **Provider**: [You.com](https://you.com) · **Search**: ✅ · **Fetch**: — · **Quota**: ✅
- **Provider**: [Jina](https://jina.ai) · **Search**: ✅ · **Fetch**: ✅ · **Quota**: Best effort
- **Provider**: [SearXNG](https://docs.searxng.org) · **Search**: ✅ · **Fetch**: — · **Quota**: Self-hosted

  ![Provider settings and quota](assets/providerDetail.png)

A simple starting point:

### Use case · Try
- **Use case**: General search · **Try**: Tavily
- **Use case**: Semantic / technical search · **Try**: Exa
- **Use case**: Search + page content · **Try**: Firecrawl / Parallel / Jina
- **Use case**: General Web search · **Try**: Brave
- **Use case**: Web / News · **Try**: You.com
- **Use case**: Self-hosted · **Try**: SearXNG
...
- **Provider**: Tavily · **Free / signup credits**: 1,000 credits / month
- **Provider**: Exa · **Free / signup credits**: $20 on signup + $10 / month
- **Provider**: Firecrawl · **Free / signup credits**: 1,000 credits / month
- **Provider**: Parallel · **Free / signup credits**: Up to $80 on signup + $5 / month
- **Provider**: Brave Search · **Free / signup credits**: $5 credits / month
- **Provider**: You.com · **Free / signup credits**: $100 for new accounts
- **Provider**: Jina · **Free / signup credits**: 10M tokens for a new API key
- **Provider**: SearXNG · **Free / signup credits**: Self-hosted, no platform quota
...
```
  ...
  ![Provider fallback](assets/searchfallback.png)
...
### Provider · Quota
- **Provider**: Tavily · **Quota**: ✅
- **Provider**: Firecrawl · **Quota**: ✅
- **Provider**: Brave · **Quota**: ✅
- **Provider**: You.com · **Quota**: ✅
- **Provider**: Jina · **Quota**: ✅
- **Provider**: Exa · **Quota**: —
- **Provider**: Parallel · **Quota**: Dashboard only
- **Provider**: SearXNG · **Quota**: Self-hosted
...
- search results
  ...
  ![Test Search](assets/overviewAndTestSearch.png)
...
back through the sources in the order you've configured.
  ...
  ![Web Search toggle](assets/searchMode.png)
