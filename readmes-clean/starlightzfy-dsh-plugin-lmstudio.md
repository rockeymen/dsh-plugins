...
- **Field**: `baseURL` · **Default**: `http://127.0.0.1:1234/v1` · **Meaning**: LM Studio OpenAI-compatible endpoint
- **Field**: `api` · **Default**: `openai-completions` · **Meaning**: Wire protocol
- **Field**: `models` · **Default**: one example model · **Meaning**: Replace with what you actually load
