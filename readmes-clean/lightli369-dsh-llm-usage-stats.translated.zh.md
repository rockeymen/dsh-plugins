...
### 方法 · 路径 · 说明
- **方法**: GET · **路径**: `/llm-usage-stats/api/query?from=YYYY-MM-DD&to=YYYY-MM-DD&model=all` · **说明**: 按天 × 模型的聚合数据
- **方法**: GET · **路径**: `/llm-usage-stats/api/status` · **说明**: 数据目录、落盘间隔、上次落盘时间
- **方法**: GET · **路径**: `/llm-usage-stats/api/models` · **说明**: 已配置模型列表 + 默认模型
- **方法**: POST · **路径**: `/llm-usage-stats/api/flush` · **说明**: 立即落盘
- **方法**: POST · **路径**: `/llm-usage-stats/api/clear` · **说明**: 清空全部记录
- **方法**: POST · **路径**: `/llm-usage-stats/api/set-interval?n=300` · **说明**: 修改落盘间隔（30–86400 秒）
