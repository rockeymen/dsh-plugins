...
- **Variable**: `DSH_AWIKI_USER_SERVICE_URL` · **Purpose**: Absolute AWiki user-service URL · **Default**: `https://awiki.ai`
- **Variable**: `DSH_AWIKI_USER_SERVICE_DOMAIN` · **Purpose**: Composition default for the Handle provider domain · **Default**: `awiki.ai`
- **Variable**: `DSH_AWIKI_MESSAGE_SERVICE_URL` · **Purpose**: Message-service URL called by the Host · **Default**: `https://awiki.ai`
- **Variable**: `DSH_AWIKI_MESSAGE_SERVICE_DID` · **Purpose**: Authoritative message-service DID · **Default**: `did:wba:awiki.ai`
- **Variable**: `DSH_AWIKI_MESSAGE_SERVICE_PUBLIC_URL` · **Purpose**: Public endpoint written to protocol records · **Default**: `https://awiki.ai`
- **Variable**: `DSH_AWIKI_ALLOWED_ATTACHMENT_ORIGINS` · **Purpose**: JSON array of extra exact HTTPS origins · **Default**: `[]`
- **Variable**: `DSH_AWIKI_STATE_ROOT` · **Purpose**: Private Rust IM Core state directory · **Default**: `$DSH_HOME/awiki/im-core` or `~/.dsh/awiki/im-core`
- **Variable**: `DSH_AWIKI_POLL_INTERVAL_MS` · **Purpose**: Open-dialog polling interval · **Default**: `5000`
- **Variable**: `DSH_AWIKI_ATTACHMENT_MAX_BYTES` · **Purpose**: Decoded attachment limit · **Default**: `10485760`
- **Variable**: `DSH_AWIKI_SUMMARY_MAX_INPUT_BYTES` · **Purpose**: UTF-8 cap after Host-side summary minimization · **Default**: `32768`
- **Variable**: `DSH_AWIKI_SUMMARY_TIMEOUT_MS` · **Purpose**: One-shot model deadline · **Default**: `30000`
- **Variable**: `DSH_AWIKI_SUMMARY_MAX_OUTPUT_TOKENS` · **Purpose**: Structured summary output cap · **Default**: `768`
