...
- **Option**: `maxIndexDepth` · **Default**: `3` · **Range**: `0–10` · **Description**: Maximum workspace indexing depth
- **Option**: `maxIndexEntries` · **Default**: `200` · **Range**: `1–2000` · **Description**: Maximum number of entries retained per candidate index
- **Option**: `referenceRoot` · **Default**: `''` · **Range**: Absolute path or empty · **Description**: Overrides the current Session workspace; empty uses the Session workspace
