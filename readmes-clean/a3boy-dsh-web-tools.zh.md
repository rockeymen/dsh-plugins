...
[English](README.md) | **简体中文**
  ...
  ![dsh-web-tools 设置页](assets/overview.png)
...
- **Provider**: [SearXNG](https://docs.searxng.org) · **Search**: ✅ · **Fetch**: — · **Quota**: Self-hosted
  ...
  ![Provider 配置与额度](assets/providerDetail.png)
...
- **用途**: 普通搜索 · **可以先试**: Tavily
- **用途**: 语义 / 技术搜索 · **可以先试**: Exa
- **用途**: 搜索 + 网页正文 · **可以先试**: Firecrawl / Parallel / Jina
- **用途**: 常规 Web 搜索 · **可以先试**: Brave
- **用途**: Web / News · **可以先试**: You.com
- **用途**: 自托管 · **可以先试**: SearXNG
...
### Provider · 免费额度 / 新用户额度
- **Provider**: Tavily · **免费额度 / 新用户额度**: 1,000 credits / 月
- **Provider**: Exa · **免费额度 / 新用户额度**: 注册送 $20 + 每月 $10
- **Provider**: Firecrawl · **免费额度 / 新用户额度**: 1,000 credits / 月
- **Provider**: Parallel · **免费额度 / 新用户额度**: 注册送最高 $80 + 每月 $5
- **Provider**: Brave Search · **免费额度 / 新用户额度**: 每月 $5 credits
- **Provider**: You.com · **免费额度 / 新用户额度**: 新账号 $100 credits
- **Provider**: Jina · **免费额度 / 新用户额度**: 新 API Key 10M tokens
- **Provider**: SearXNG · **免费额度 / 新用户额度**: 自托管，无平台额度
...
```
  ...
  ![搜索源自动切换](assets/searchfallback.png)
...
### Provider · 额度
- **Provider**: Tavily · **额度**: ✅
- **Provider**: Firecrawl · **额度**: ✅
- **Provider**: Brave · **额度**: ✅
- **Provider**: You.com · **额度**: ✅
- **Provider**: Jina · **额度**: ✅
- **Provider**: Exa · **额度**: —
- **Provider**: Parallel · **额度**: Dashboard only
- **Provider**: SearXNG · **额度**: Self-hosted
