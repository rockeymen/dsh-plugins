...
### 类别 · 当前支持
- **类别**: 自动产物 · **当前支持**: Markdown、MDX、PDF、SVG、PNG、JPEG、WebP、GIF、AVIF、BMP
- **类别**: 按需产物 · **当前支持**: TXT、JSON、JSONL、CSV、TSV；仅在 Agent 回复中明确提到文件路径或名称时显示
- **类别**: 不展示 · **当前支持**: 源码、HTML/HTM、配置、日志、YAML、TOML、XML、INI、CONF 等项目内部文件
