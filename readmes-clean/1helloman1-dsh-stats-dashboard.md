...
### 模型 · 输入（未命中） · 缓存读 · 输出
- **模型**: deepseek-v4-flash · **输入（未命中）**: ¥1.00 · **缓存读**: ¥0.02 · **输出**: ¥2.00
- **模型**: deepseek-v4-pro · **输入（未命中）**: ¥3.00 · **缓存读**: ¥0.025 · **输出**: ¥6.00
- **模型**: deepseek-chat · **输入（未命中）**: ¥2.00 · **缓存读**: ¥0.50 · **输出**: ¥8.00
- **模型**: deepseek-reasoner · **输入（未命中）**: ¥4.00 · **缓存读**: ¥1.00 · **输出**: ¥16.00
