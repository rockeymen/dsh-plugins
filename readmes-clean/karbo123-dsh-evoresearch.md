...
### 文档 · 内容
- **文档**: [docs/01-architecture.md](docs/01-architecture.md) · **内容**: 架构设计与数据流
- **文档**: [docs/02-feature-map.md](docs/02-feature-map.md) · **内容**: 能力清单
- **文档**: [docs/03-development.md](docs/03-development.md) · **内容**: 开发指南
- **文档**: [docs/04-desktop.md](docs/04-desktop.md) · **内容**: 桌面版构建
