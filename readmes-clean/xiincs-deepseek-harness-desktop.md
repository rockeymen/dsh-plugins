...
![DeepSeek Harness Desktop 运行截图](docs/screenshots/app-running.png)
...
### 系统 · 安装包 · 说明
- **系统**: Windows · **安装包**: `.exe` · **说明**: 已签名，支持自动更新，双击安装即可
- **系统**: macOS · **安装包**: `.dmg` · **说明**: 首次打开需要在「系统设置 → 隐私与安全性」里手动允许一次（未加入 Apple 开发者计划，属正常现象）
- **系统**: Linux · **安装包**: `.deb` · **说明**: `dpkg -i` 或用系统自带的安装器打开即可

> macOS / Linux 版暂不支持自动更新，有新版本时需要自己回来这个页面重新下载。

  ![启动页](docs/screenshots/app-boot.png)
