...
### 供应商 · 默认档 · 档位 · 额度口径
- **供应商**: OpenCode Go（`opencode-go`） · **默认档**: $10/月 · **档位**: — · **额度口径**: 周 $30（V4 Flash 约 79,050 请求/周）
- **供应商**: OpenAI Codex（`openai-codex`） · **默认档**: Plus $20/月 · **档位**: Plus / Pro 5x $100 / Pro 20x $200 / Business · **额度口径**: ~100 请求/周（参考）
- **供应商**: GitHub Copilot（`github-copilot`） · **默认档**: Pro $10/月 · **档位**: Free / Pro / Pro+ $39 / Max $100 / Business / Enterprise · **额度口径**: AI Credits 月 $15（Pro）
- **供应商**: Claude Code（`claude-sub`） · **默认档**: Pro $20/月 · **档位**: Pro / Max 5x $100 / Max 20x $200 · **额度口径**: 官方未公布请求数（5h 窗口 1x/5x/20x）
- **供应商**: Google AI / Gemini CLI（`google-ai-sub`） · **默认档**: AI Pro $19.99/月 · **档位**: AI Pro / Ultra 5x $99.99 / Ultra 20x $199.99 · **额度口径**: 1,500 请求/天（Pro）

**按量计费（Token 计划）— 自动带官方价：**

### 供应商 · 已收录模型
- **供应商**: OpenAI（`openai`） · **已收录模型**: gpt-5.6 sol/terra/luna、gpt-5.5、gpt-5.4 系、gpt-5 系、gpt-5.2、o3/o4-mini/o1
- **供应商**: Anthropic（`anthropic`） · **已收录模型**: claude-opus-5、sonnet-5、haiku-4-5、fable-5、opus/sonnet-4.x
- **供应商**: Google（`google`） · **已收录模型**: gemini-3.7/3.6/3.5 flash、3.1-pro、2.5 pro/flash/lite
- **供应商**: xAI（`xai`） · **已收录模型**: grok-4.6、4.5、4.3、build-0.1
- **供应商**: Mistral（`mistral`） · **已收录模型**: large-3、medium-3.5、small-4、ministral-3
- **供应商**: Moonshot（`moonshot`） · **已收录模型**: kimi-k3、k2.7-code
- **供应商**: 智谱（`zhipu`） · **已收录模型**: glm-5.2、5.1、5
- **供应商**: 阿里（`qwen`） · **已收录模型**: qwen3.8-max、3.7-max/plus/flash
- **供应商**: MiniMax（`minimax`） · **已收录模型**: m3、m2.7
- **供应商**: OpenRouter（`openrouter`） · **已收录模型**: 实时目录 50 个热门模型
- **供应商**: OpenCode Zen（`opencode-zen`） · **已收录模型**: PAYG 网关价（Claude/GPT/Gemini/Grok/DeepSeek）
- **供应商**: DeepSeek（`deepseek`） · **已收录模型**: v4-flash、v4-pro
...
- **模型**: deepseek-v4-flash · **输入(未命中)**: $0.14 · **输入(缓存命中)**: $0.0028 · **缓存写**: 0* · **输出**: $0.28
- **模型**: deepseek-v4-pro · **输入(未命中)**: $0.435 · **输入(缓存命中)**: $0.003625 · **缓存写**: 0* · **输出**: $0.87
- **模型**: gpt-5.6-sol · **输入(未命中)**: $5.00 · **输入(缓存命中)**: $0.50 · **缓存写**: $6.25 · **输出**: $30.00
- **模型**: gpt-5.6-terra · **输入(未命中)**: $2.00 · **输入(缓存命中)**: $0.20 · **缓存写**: $2.50 · **输出**: $12.00
- **模型**: gpt-5.6-luna · **输入(未命中)**: $0.20 · **输入(缓存命中)**: $0.02 · **缓存写**: $0.25 · **输出**: $1.20
