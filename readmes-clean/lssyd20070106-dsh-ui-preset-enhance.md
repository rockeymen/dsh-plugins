...
## 效果预览
  ...
  ![DSH WebUI background preview](assets/preview-home.png)

  ![DSH appearance settings prototype](assets/preview-settings.png)
...
### 功能 · 简单说明
- **功能**: 🖼️ 自定义背景 · **简单说明**: 本地上传、网络图片或 5 个渐变预设
- **功能**: 🌫️ 透明与模糊 · **简单说明**: 调整 DSH 界面层透明度和壁纸模糊
- **功能**: 🎨 主题颜色 · **简单说明**: 主色、辅助色与强调色阶
- **功能**: 📑 Prompt 预设 · **简单说明**: 7 个内置模板 + 自定义保存 / 删除 / 快速载入
- **功能**: 📊 Token / Context · **简单说明**: 查看当前 Session 的 Context 压力、窗口和 Token 组成
- **功能**: 🧹 手动 Compact · **简单说明**: 通过当前 Session 的 DSH 命令接口执行 `/compact`
