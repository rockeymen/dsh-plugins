...
- **输出形态** · **进入创作（激活「·创作」）**: **小说正文**：第三人称连贯叙述，细节符合设定风格，直接输出正文、不复述设定 · **世界书模式（激活「·世界书」）**: **对话/角色扮演回应**：以世界内角色身份与你互动、推进剧情
- **设定使用** · **进入创作（激活「·创作」）**: 全文注入，模型自觉参考 · **世界书模式（激活「·世界书」）**: 全文注入 + **关键词自动触发**：提到触发词时对应条目当场注入
- **交互方式** · **进入创作（激活「·创作」）**: 你给场景/情节/人物，模型创作；继续给 → 续写 · **世界书模式（激活「·世界书」）**: 你以第一人称参与，模型以角色回应
- **典型指令** · **进入创作（激活「·创作」）**: "写一段……"、"描写……的过程" · **世界书模式（激活「·世界书」）**: "我是……，然后呢？"、"把名单给我看看"
- **适合** · **进入创作（激活「·创作」）**: 写小说、场景描写、剧情创作 · **世界书模式（激活「·世界书」）**: 沉浸式角色扮演、互动推演
...
### 数据 · 路径
- **数据**: 预设（含创作/世界书预设正文） · **路径**: `~/.dsh/dsh-LorebookMD/presets.json`
- **数据**: 世界书条目数据（关键词触发用） · **路径**: `~/.dsh/dsh-LorebookMD/worldbooks.json`
- **数据**: 本地设定文档（可编辑） · **路径**: `~/.dsh/dsh-LorebookMD/worldbooks/<名>.md`
