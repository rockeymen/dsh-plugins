...
### 想调什么 · 去哪改
- **想调什么**: 音效音量 · **去哪改**: `playKeyClick` / `blip()` 里的增益值
- **想调什么**: 扫描线密度 / 颜色 · **去哪改**: CSS `#root::after`
- **想调什么**: RELIC 频率 / 强度 · **去哪改**: `startRelicLoop()` 的间隔 + `cpShift` 动画
- **想调什么**: 代码背景内容 / 速度 · **去哪改**: `startCodeBg()` + `.cp-code-line` 颜色
