...
### Var · Default · Meaning
- **Var**: `DSH_KANBAN_WORKER_CMD` · **Default**: `dsh --profile headless` · **Meaning**: Worker launch command
- **Var**: `DSH_KANBAN_MAX_WORKERS` · **Default**: `4` · **Meaning**: Global concurrent-worker cap
- **Var**: `DSH_KANBAN_PYTHON` · **Default**: auto (uv, then python3) · **Meaning**: Sidecar Python interpreter
- **Var**: `DSH_KANBAN_ROOT` · **Default**: `<DSH_HOME>/storages/kanban` · **Meaning**: Board data directory
