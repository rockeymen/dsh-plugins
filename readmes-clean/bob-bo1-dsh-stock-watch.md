...
### 字段 · 必填 · 说明
- **字段**: `code` · **必填**: 是 · **说明**: `sh`、`sz` 或 `bj` 加 5～6 位数字，例如 `sz000001`
- **字段**: `name` · **必填**: 否 · **说明**: 自定义名称；不填时使用行情接口返回的名称
- **字段**: `quantity` · **必填**: 是 · **说明**: 持仓数量，必须大于 0
- **字段**: `costPrice` · **必填**: 是 · **说明**: 成本价，必须大于 0
- **字段**: `refreshSeconds` · **必填**: 否 · **说明**: 行情刷新间隔，支持 1～3600 秒，默认 5 秒
