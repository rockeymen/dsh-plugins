...
- **模型**: deepseek-v4-flash · **档位**: 原价 · **输入（缓存命中）**: 0.02 · **输入（未命中）**: 1.00 · **输出**: 2.00
- **模型**: deepseek-v4-flash · **档位**: 高峰价 · **输入（缓存命中）**: 0.10 · **输入（未命中）**: 3.00 · **输出**: 9.00
- **模型**: deepseek-v4-flash · **档位**: 空闲价 · **输入（缓存命中）**: 0.05 · **输入（未命中）**: 1.50 · **输出**: 4.50
- **模型**: deepseek-v4-pro · **档位**: 原价 · **输入（缓存命中）**: 0.025 · **输入（未命中）**: 3.00 · **输出**: 6.00
- **模型**: deepseek-v4-pro · **档位**: 高峰价 · **输入（缓存命中）**: 0.30 · **输入（未命中）**: 9.00 · **输出**: 27.00
- **模型**: deepseek-v4-pro · **档位**: 空闲价 · **输入（缓存命中）**: 0.15 · **输入（未命中）**: 4.50 · **输出**: 13.50
- **模型**: deepseek-chat · **档位**: 仅原价 · **输入（缓存命中）**: 0.5 · **输入（未命中）**: 2 · **输出**: 3
- **模型**: deepseek-reasoner · **档位**: 仅原价 · **输入（缓存命中）**: 1 · **输入（未命中）**: 4 · **输出**: 16
...
![费用胶囊预览 — 悬浮在会话左下角的费用胶囊](docs/cost-chip.png)
...
- 数据来自 host 的 `/cost-panel/data?session=` JSON 路由（价格与配置只在
