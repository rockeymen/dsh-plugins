...
![dshmobile banner](docs/images/banner.png)
...
手机端（左→右：扫码登录 → 会话/设备 → 对话）：
  ...
  ![扫码登录](docs/images/phone-1.jpg)
  ![会话/设备](docs/images/phone-2.jpg)
  ![对话](docs/images/phone-3.jpg)

电脑端插件面板（Web 左侧栏底部箭头 → 弹窗，常驻二维码与登录态无关）：

![DSH 插件面板](docs/images/plugin-panel.jpg)
