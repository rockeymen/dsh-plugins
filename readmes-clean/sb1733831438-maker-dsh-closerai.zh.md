...
### 版本 · 范围 · 状态
- **版本**: v0.0.1 · **范围**: Bootstrap：monorepo、工具链、Mock Provider、CI · **状态**: 已发布
- **版本**: v0.0.2 · **范围**: 桌面外壳：DSH 监督器 + 加固 Electron 窗口 · **状态**: 已发布
- **版本**: v0.0.3 · **范围**: 首次引导、OS 钥匙串密钥、DeepSeek/OpenAI 兼容 Provider、Mock 模式 · **状态**: 已发布
- **版本**: v0.0.4 · **范围**: Chat / Work / Code 权限隔离模式 · **状态**: 已发布
- **版本**: v0.0.5 · **范围**: 日常对话：会话持久化、历史、项目、文件处理 · **状态**: 进行中
