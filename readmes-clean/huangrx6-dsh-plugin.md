...
### 插件 · 一句话 · 详细文档
- **插件**: [`dsh-layout`](./dsh-layout) · **一句话**: 页面布局与材质：一张磨砂材质覆盖整页，全局（圆角/背景/弹窗/边距）+ 对话排版（阅读宽度/收笔/气泡/轨迹/统计） · **详细文档**: **[→ dsh-layout/README.md](./dsh-layout/README.md)**
- **插件**: [`dsh-skill-manager`](./dsh-skill-manager) · **一句话**: Skill 导入（URL / GitHub / zip）与详情查看：来源层级、frontmatter 元数据、文件树、多格式实时预览 · **详细文档**: **[→ dsh-skill-manager/README.md](./dsh-skill-manager/README.md)**
- **插件**: [`dsh-mcp-manager`](./dsh-mcp-manager) · **一句话**: MCP 服务器全生命周期管理：增删改、启停、测试连接、工具明细 · **详细文档**: **[→ dsh-mcp-manager/README.md](./dsh-mcp-manager/README.md)**
- **插件**: [`dsh-remote-access`](./dsh-remote-access) · **一句话**: 远程访问：Tailscale Serve 把本机 dsh 暴露为 HTTPS 地址 + 切换官方 browse 目录选择器，手机扫码即用 · **详细文档**: **[→ dsh-remote-access/README.md](./dsh-remote-access/README.md)**
