...
### 层级 · 职责
- **层级**: 根内核 · **职责**: 总纲、自适应推进、最小底线与加载地图
- **层级**: `dao.md` · **职责**: 事的所有权、事实校准、授权、参考只读与高影响边界
- **层级**: `craft.md` · **职责**: 规划、实施、设计、UI / 实时交互、文档与审查
- **层级**: `verification.md` · **职责**: 验收、证据强度、完成判断与旧任务恢复
- **层级**: `support.md` · **职责**: 自我校准、表现恢复、长期状态与记忆、关系连续性、合议与连续审查
- **层级**: `leverage.md` · **职责**: 能力升降、外部能力的发现、净增益、安装、创建、组合与 agent 协作
...
### 桌宠 · 角色定位 · 性格 · 分工
- **桌宠**: [阿岱（`dai`）](pets/dai/) · **角色定位**: 黑青行事官与执行搭档 · **性格**: 沉着、可靠、克制 · **分工**: 推进任务、执行、验收并收尾
- **桌宠**: [欧黛（`odai`）](pets/odai/) · **角色定位**: 银白蓝紫吉祥物与陪伴搭档 · **性格**: 活泼、亲近、好奇 · **分工**: 陪伴、卖萌、回应进展、打气并庆祝完成
...
### 宿主 · 写前只读路径保护 · 收口前显式验收
- **宿主**: Codex · **写前只读路径保护**: `PreToolUse` · **收口前显式验收**: `Stop`
- **宿主**: Claude Code · **写前只读路径保护**: `PreToolUse` · **收口前显式验收**: `Stop`
- **宿主**: GitHub Copilot · **写前只读路径保护**: `preToolUse` · **收口前显式验收**: `agentStop`
- **宿主**: Gemini CLI · **写前只读路径保护**: `BeforeTool` · **收口前显式验收**: `AfterAgent`
- **宿主**: Grok Build · **写前只读路径保护**: `PreToolUse` · **收口前显式验收**: —
- **宿主**: Kimi Code CLI · **写前只读路径保护**: `PreToolUse` · **收口前显式验收**: `Stop`
...
- **Runner**: GPT-5.6-sol / high · **全量 on**: **144/144** · **A/B on**: **96/96** · **A/B off**: 80/96 · **净增**: **+16** · **A/B runner token on / off**: 396,899 / 317,761（+24.9%）
- **Runner**: Claude Opus 5 · **全量 on**: **144/144** · **A/B on**: **96/96** · **A/B off**: 77/96 · **净增**: **+19** · **A/B runner token on / off**: 2,273,558 / 1,937,782（+17.3%）
- **Runner**: Grok 4.6 / default high · **全量 on**: **144/144** · **A/B on**: **96/96** · **A/B off**: 67/96 · **净增**: **+29** · **A/B runner token on / off**: 2,236,506 / 1,285,461（+74.0%）
- **Runner**: Grok 4.5 · **全量 on**: **144/144** · **A/B on**: **96/96** · **A/B off**: 69/96 · **净增**: **+27** · **A/B runner token on / off**: 1,579,533 / 1,054,670（+49.8%）
- **Runner**: Gemini 3.7 Flash High · **全量 on**: 134/144 · **A/B on**: 88/96 · **A/B off**: 72/96 · **净增**: **+16** · **A/B runner token on / off**: 1,813,203 / 1,580,475（+14.7%）
- **Runner**: Gemini 3.6 Flash High · **全量 on**: 126/144 · **A/B on**: 82/96 · **A/B off**: 67/96 · **净增**: **+15** · **A/B runner token on / off**: 1,381,447 / 2,235,193（-38.2%）
- **Runner**: Kimi K3 · **全量 on**: **144/144** · **A/B on**: **96/96** · **A/B off**: 75/96 · **净增**: **+21** · **A/B runner token on / off**: 2,192,056 / 1,632,057（+34.3%）
- **Runner**: DeepSeek V4 Pro / max（DSH） · **全量 on**: **144/144** · **A/B on**: **96/96** · **A/B off**: 63/96 · **净增**: **+33** · **A/B runner token on / off**: 2,131,373 / 1,652,030（+29.0%）
- **Runner**: DeepSeek V4 Flash · **全量 on**: **144/144** · **A/B on**: **96/96** · **A/B off**: 61/96 · **净增**: **+35** · **A/B runner token on / off**: 5,341,138 / 3,975,731（+34.3%）
