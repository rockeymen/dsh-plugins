...
- **模型**: deepseek-v4-flash（当前价） · **缓存命中输入**: ¥0.02 · **缓存未命中输入**: ¥1.0 · **输出**: ¥2.0
- **模型**: deepseek-v4-pro（当前价） · **缓存命中输入**: ¥0.025 · **缓存未命中输入**: ¥3.0 · **输出**: ¥6.0
- **模型**: 2026-08-17 起（峰谷） · **缓存命中输入**: 高峰半价 · **缓存未命中输入**: 高峰价 · **输出**: 高峰价
