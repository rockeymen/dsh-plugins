# All in Luna
  ...
  ![All in Luna mark](docs/assets/brand/all-in-luna-mark.svg)
...
**Parallel across tasks. Recursive inside tasks.**
  ...
  ![All in Luna task topology](docs/assets/brand/hero-topology.svg)
...
**All in Luna starts from one simple idea: one conversation should not have to carry an entire project.**
  ...
  ![One giant context versus clear task lanes](docs/assets/brand/before-after.svg)
...
# Models & performance
  ...
  ![Models and performance routing](docs/assets/brand/models-performance.svg)
...
**All in Flash** is the [DeepSeek Harness (DSH)](https://github.com/deepseek-ai/deepseek-harness)
bundle for All in Luna. It turns frozen All in Luna top-level task actions into
durable DSH lane children, while preserving the exact action and receipt
contract.
