...
- **Field**: `previewMode` · **Default**: `names-only` · **Valid values**: `names-only`, `redacted`, `full` · **Meaning**: Tool payload visibility
- **Field**: `maxPreviewBytes` · **Default**: `2048` · **Valid values**: `128..65536` · **Meaning**: Maximum preview bytes per value
- **Field**: `sensitiveFieldNames` · **Default**: common credential names · **Valid values**: string array · **Meaning**: Case-insensitive object keys removed in redacted mode
- **Field**: `tokenPublishIntervalMs` · **Default**: `250` · **Valid values**: `50..5000` · **Meaning**: Token update coalescing interval
- **Field**: `velocityWindowMs` · **Default**: `5000` · **Valid values**: `1000..60000` · **Meaning**: Rolling recent-token-rate window
- **Field**: `maxLiveRows` · **Default**: `300` · **Valid values**: `50..2000` · **Meaning**: Maximum Tool rows retained per viewing epoch
- **Field**: `maxPendingFrames` · **Default**: `64` · **Valid values**: `8..512` · **Meaning**: Maximum queued SSE frames per subscriber
