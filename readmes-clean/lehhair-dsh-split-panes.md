...
### 方式 · 说明
- **方式**: **官方合入后** · **说明**: 纯插件安装，无需任何前置（讨论帖 604 推进中）
- **方式**: **带能力的 DSH** · **说明**: 使用已内置该能力的内测发行版
- **方式**: **渲染器补丁** · **说明**: 对官方 `0.1.0-rc.5` 基线应用 `patches/dsh-session-scope-and-panes-rc5.patch`（约 500 行纯新增，应用方法见 [patches/README](patches/README.md)）
...
- 构建产物 `lib/client.js` 由 harness 以 `/plugins//client.js` 提供
