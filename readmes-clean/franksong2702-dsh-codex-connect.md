...
Connect your ChatGPT subscription to DeepSeek Harness with OAuth, user-controlled defaults, Harness-native approvals, diagnostics, and reliable session recovery.
  ...
  ![Codex Connect — ChatGPT OAuth for DeepSeek Harness](https://raw.githubusercontent.com/franksong2702/dsh-codex-connect/main/docs/assets/hero.jpg)
...
Sign in and manage the plugin from **Settings → Plugins → Plugin configuration → Codex Connect**.
  ...
  ![Codex Connect ChatGPT OAuth status inside Harness plugin configuration](https://raw.githubusercontent.com/franksong2702/dsh-codex-connect/main/docs/assets/oauth-status.jpg)

Optional Codex search and `view_image` capabilities remain explicit, profile-scoped choices:

  ![Codex Connect optional capability settings in DeepSeek Harness](https://raw.githubusercontent.com/franksong2702/dsh-codex-connect/main/docs/assets/plugin-configuration.jpg)

Codex models then appear in Harness's normal model picker alongside the existing providers:

  ![OpenAI Codex models in the DeepSeek Harness model picker](https://raw.githubusercontent.com/franksong2702/dsh-codex-connect/main/docs/assets/model-selector.jpg)
