...
### 功能 · 说明
- **功能**: 节点导航条 · **说明**: 对话区右缘纵向节点串，每 user 消息一个圆点节点
- **功能**: 跟随阅读位置 · **说明**: 激活药丸（22px 品牌蓝胶囊）随当前阅读位置移动
- **功能**: 悬停预览 · **说明**: 悬停节点显示消息预览卡（6 行截断，对齐官方 HoverCard 视觉）
- **功能**: 点击跳转 · **说明**: 平滑滚动到对应消息 + 品牌蓝高亮环
- **功能**: 滑动窗口 · **说明**: >11 节点时只显示窗口内节点（避免溢出）
- **功能**: 自动隐藏 · **说明**: <2 条 user 消息或非对话页不显示
