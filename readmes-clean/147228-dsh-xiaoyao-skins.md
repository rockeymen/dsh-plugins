...
| 官网黑鲸 × 石墨黑 × 小瑶粉`use black-whale` | 深海蓝 × 猫娘粉 × 鲸鱼光效`use ocean` |
...
| 云端白昼 × 双主角协作`use sky-lab` | 炭黑长城 × 中国红 × 古金`use great-wall-beacon` |
...
| 米白宣纸 × 朱红 × 朝霞金`use great-wall-sunrise` | 雪白 × 墨灰 × 正红披风`use great-wall-snow` |
